 ...
 *
 * Symbolic function: spline5_rot2_acceleration
 *
 * Args:
 *     dt: Scalar
 *     lambdas: Matrix53
...
Eigen::Matrix<Scalar, 1, 1> Spline5Rot2AccelerationGlobal(
    const Scalar dt, const Eigen::Matrix<Scalar, 5, 3>& lambdas, const sym::Rot2<Scalar>& x0,
