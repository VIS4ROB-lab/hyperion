 ...
 *
 * Symbolic function: spline5_rot2_value
 *
 * Args:
 *     lambdas: Matrix51
 *     x0: Rot2
...
sym::Rot2<Scalar> Spline5Rot2Value(const Eigen::Matrix<Scalar, 5, 1>& lambdas,
                                   const sym::Rot2<Scalar>& x0, const sym::Rot2<Scalar>& x1,
                                   const sym::Rot2<Scalar>& x2, const sym::Rot2<Scalar>& x3,
                                   const sym::Rot2<Scalar>& x4, const sym::Rot2<Scalar>& x5,
