 ...
 *
 * Symbolic function: spline3_pose2_value
 *
 * Args:
 *     lambdas: Matrix31
 *     x0: Pose2
...
sym::Pose2<Scalar> Spline3Pose2Value(const Eigen::Matrix<Scalar, 3, 1>& lambdas,
  ...
  _res[0] = _tmp14 * _x0[0] - _tmp15 * _x0[1];
  _res[1] = _tmp14 * _x0[1] + _tmp15 * _x0[0];
