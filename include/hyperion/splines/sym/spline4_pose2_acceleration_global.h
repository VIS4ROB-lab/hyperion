...
Eigen::Matrix<Scalar, 3, 1> Spline4Pose2AccelerationGlobal(
  ...
  const Scalar _tmp9 =
      _tmp2 * lambdas(2, 2) + _tmp4 * lambdas(3, 2) + _tmp6 * lambdas(1, 2) + _tmp8 * lambdas(0, 2);
  ...
  _res(0, 0) = _tmp0 * _tmp9;
  _res(1, 0) = _tmp0 * (_tmp10 * lambdas(2, 2) + _tmp11 * lambdas(1, 2) + _tmp12 * lambdas(0, 2) +
                        _tmp13 * lambdas(3, 2) +
                        _tmp18 * (_tmp14 * lambdas(2, 1) + _tmp15 * lambdas(1, 1) +
                                  _tmp16 * lambdas(0, 1) + _tmp17 * lambdas(3, 1)) +
                        _tmp9 * (_tmp14 * lambdas(2, 0) + _tmp15 * lambdas(1, 0) +
                                 _tmp16 * lambdas(0, 0) + _tmp17 * lambdas(3, 0) + _x0[3]));
  _res(2, 0) = _tmp0 * (_tmp14 * lambdas(2, 2) + _tmp15 * lambdas(1, 2) + _tmp16 * lambdas(0, 2) +
                        _tmp17 * lambdas(3, 2) -
                        _tmp18 * (_tmp10 * lambdas(2, 1) + _tmp11 * lambdas(1, 1) +
                                  _tmp12 * lambdas(0, 1) + _tmp13 * lambdas(3, 1)) -
                        _tmp9 * (_tmp10 * lambdas(2, 0) + _tmp11 * lambdas(1, 0) +
                                 _tmp12 * lambdas(0, 0) + _tmp13 * lambdas(3, 0) + _x0[2]));
