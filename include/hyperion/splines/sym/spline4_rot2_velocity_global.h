 ...
 *
 * Symbolic function: spline4_rot2_velocity
 *
 * Args:
 *     dt: Scalar
 *     lambdas: Matrix42
...
Eigen::Matrix<Scalar, 1, 1> Spline4Rot2VelocityGlobal(
    const Scalar dt, const Eigen::Matrix<Scalar, 4, 2>& lambdas, const sym::Rot2<Scalar>& x0,
