...
Eigen::Matrix<Scalar, 5, 2> CumulativeUniformBSplineLambdas61(const Scalar ut) {
  // Total ops: 56
  ...
  const Scalar _tmp18 = (Scalar(1) / Scalar(2)) * _tmp6;
  const Scalar _tmp19 = -Scalar(1) / Scalar(6) * _tmp4;
  const Scalar _tmp20 = _tmp10 + Scalar(11) / Scalar(24);
  ...
  _res(1, 1) = -_tmp17 + _tmp18 + _tmp19 + _tmp20;
  _res(2, 1) = _tmp17 - _tmp18 + _tmp20 + (Scalar(1) / Scalar(4)) * _tmp4;
  _res(3, 1) = _tmp14 + _tmp15 + _tmp16 + _tmp19;
  _res(4, 1) = _tmp5;
