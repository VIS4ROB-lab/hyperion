...
Eigen::Matrix<Scalar, 6, 1> Spline3Pose3SensorVelocityGlobal(
  ...
  const Scalar _tmp56 = 4 * _tmp52 * lambdas(1, 0) * std::cos(_tmp51) / _tmp50;
  ...
  const Scalar _tmp67 = _tmp39 * _tmp42;
  ...
  const Scalar _tmp73 = _tmp32 * _tmp57;
  const Scalar _tmp74 = -_tmp47 * _tmp53 + 1;
  const Scalar _tmp75 = _tmp41 * _tmp43 + _tmp63 * (_tmp72 - _tmp73) + _tmp66 * (_tmp68 + _tmp69) +
                        _tmp70 * (_tmp64 + _tmp74);
  const Scalar _tmp76 = _tmp26 * _tmp7;
  const Scalar _tmp77 = _tmp28 * _tmp30;
  const Scalar _tmp78 = _tmp5 * _tmp77;
  const Scalar _tmp79 = _tmp40 * _tmp67 + _tmp63 * (_tmp65 + _tmp74) + _tmp66 * (_tmp55 - _tmp58) +
  ...
  const Scalar _tmp84 = _tmp6 * _tmp83 + _tmp71 * (_tmp27 - _tmp31) + _tmp75 * (_tmp76 + _tmp78) +
                        _tmp79 * (_tmp80 + _tmp81);
  const Scalar _tmp85 = _tmp1 * _x0[3];
  const Scalar _tmp86 = _tmp3 * _x0[0];
  const Scalar _tmp87 = -_tmp18 * _tmp25;
  const Scalar _tmp88 = _tmp6 * _tmp77;
  const Scalar _tmp89 = _tmp25 * _tmp5 * _tmp7;
  const Scalar _tmp90 = _tmp5 * _tmp83 + _tmp71 * (_tmp81 + _tmp87) + _tmp75 * (-_tmp88 + _tmp89) +
                        _tmp79 * (_tmp27 + _tmp31);
  const Scalar _tmp91 = -2 * std::pow(_x0[1], Scalar(2));
  const Scalar _tmp92 = 1 - 2 * std::pow(_x0[2], Scalar(2));
  ...
  const Scalar _tmp95 = -2 * std::pow(_x0[0], Scalar(2));
  const Scalar _tmp96 = 2 * _x0[0] * _x0[3];
  const Scalar _tmp97 = _tmp3 * _x0[1];
  const Scalar _tmp98 =
      _tmp84 * (_tmp92 + _tmp95) + _tmp90 * (-_tmp96 + _tmp97) + _tmp93 * (_tmp2 + _tmp4);
  const Scalar _tmp99 =
      _tmp84 * (_tmp96 + _tmp97) + _tmp90 * (_tmp91 + _tmp95 + 1) + _tmp93 * (-_tmp85 + _tmp86);
  const Scalar _tmp100 = -_x1[6] + _x2[6];
  const Scalar _tmp101 = -_x2[6] + _x3[6];
  const Scalar _tmp102 = -_x0[6] + _x1[6];
  const Scalar _tmp103 =
      _tmp100 * lambdas(1, 0) + _tmp101 * lambdas(2, 0) + _tmp102 * lambdas(0, 0) + _x0[6];
  const Scalar _tmp104 = -_x1[5] + _x2[5];
  const Scalar _tmp105 = -_x2[5] + _x3[5];
  const Scalar _tmp106 = -_x0[5] + _x1[5];
  const Scalar _tmp107 =
      _tmp104 * lambdas(1, 0) + _tmp105 * lambdas(2, 0) + _tmp106 * lambdas(0, 0) + _x0[5];
  const Scalar _tmp108 = -_x1[4] + _x2[4];
  const Scalar _tmp109 = -_x2[4] + _x3[4];
  const Scalar _tmp110 = -_x0[4] + _x1[4];
  const Scalar _tmp111 =
      _tmp108 * lambdas(1, 0) + _tmp109 * lambdas(2, 0) + _tmp110 * lambdas(0, 0) + _x0[4];

  // Output terms (1)
  Eigen::Matrix<Scalar, 6, 1> _res;

  _res(0, 0) = _tmp0 * _tmp94;
  _res(1, 0) = _tmp0 * _tmp98;
  _res(2, 0) = _tmp0 * _tmp99;
  _res(3, 0) = _tmp0 * (-_tmp103 * _tmp98 + _tmp107 * _tmp99 + _tmp108 * lambdas(1, 1) +
                        _tmp109 * lambdas(2, 1) + _tmp110 * lambdas(0, 1));
  _res(4, 0) = _tmp0 * (_tmp103 * _tmp94 + _tmp104 * lambdas(1, 1) + _tmp105 * lambdas(2, 1) +
                        _tmp106 * lambdas(0, 1) - _tmp111 * _tmp99);
  _res(5, 0) = _tmp0 * (_tmp100 * lambdas(1, 1) + _tmp101 * lambdas(2, 1) +
                        _tmp102 * lambdas(0, 1) - _tmp107 * _tmp94 + _tmp111 * _tmp98);
