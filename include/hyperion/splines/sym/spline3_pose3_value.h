 ...
 *
 * Symbolic function: spline3_pose3_value
 *
 * Args:
 *     lambdas: Matrix31
 *     x0: Pose3
...
sym::Pose3<Scalar> Spline3Pose3Value(const Eigen::Matrix<Scalar, 3, 1>& lambdas,
  ...
  _res[0] = _tmp63 * _x0[0] - _tmp65 * _x0[2] + _tmp66 * _x0[1] + _tmp67 * _x0[3];
  _res[1] = _tmp63 * _x0[1] + _tmp65 * _x0[3] - _tmp66 * _x0[0] + _tmp67 * _x0[2];
  _res[2] = _tmp63 * _x0[2] + _tmp65 * _x0[0] + _tmp66 * _x0[3] - _tmp67 * _x0[1];
  _res[3] = _tmp63 * _x0[3] - _tmp65 * _x0[1] - _tmp66 * _x0[2] - _tmp67 * _x0[0];
