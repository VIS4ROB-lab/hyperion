 ...
 *
 * Symbolic function: spline4_pose2_value
 *
 * Args:
 *     lambdas: Matrix41
 *     x0: Pose2
...
sym::Pose2<Scalar> Spline4Pose2Value(const Eigen::Matrix<Scalar, 4, 1>& lambdas,
  ...
  _res[0] = -_tmp20 * _x0[1] + _tmp21 * _x0[0];
  _res[1] = _tmp20 * _x0[0] + _tmp21 * _x0[1];
