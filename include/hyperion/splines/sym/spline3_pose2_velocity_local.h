 ...
 *
 * Symbolic function: spline3_pose2_velocity
 *
 * Args:
 *     dt: Scalar
 *     lambdas: Matrix32
...
Eigen::Matrix<Scalar, 3, 1> Spline3Pose2VelocityLocal(
  ...
  const Scalar _tmp22 = _tmp15 * _tmp19 + _tmp17 * _tmp18;
  ...
  _res(0, 0) = _tmp0 * (_tmp2 * lambdas(2, 1) + _tmp4 * lambdas(1, 1) + _tmp6 * lambdas(0, 1));
  _res(1, 0) = _tmp0 * (_tmp20 * _tmp21 + _tmp22 * _tmp23);
  _res(2, 0) = _tmp0 * (_tmp20 * _tmp23 - _tmp21 * _tmp22);
