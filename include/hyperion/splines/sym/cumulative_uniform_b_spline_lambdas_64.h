...
Eigen::Matrix<Scalar, 5, 5> CumulativeUniformBSplineLambdas64(const Scalar ut) {
  // Total ops: 94
  ...
  const Scalar _tmp20 = (Scalar(1) / Scalar(2)) * _tmp6;
  ...
  _res(2, 1) = _tmp17 - _tmp20 + _tmp21 + (Scalar(1) / Scalar(4)) * _tmp4;
