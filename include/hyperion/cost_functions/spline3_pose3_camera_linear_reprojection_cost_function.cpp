...
auto Spline3Pose3CameraLinearReprojectionCostFunction::evaluate(Scalar const* const* parameters,
                                                                Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 2, 1>>{residuals} =
        Spline3Pose3CameraLinearReprojectionFactor<Scalar>(lambdas_, _x0, _x1, _x2, _x3, _b_T_c,
  ...
  switch (bits | std::uint8_t{0b1111001}) {
    case std::uint8_t{0b1111111}: {
      Eigen::Map<Eigen::Matrix<Scalar, 2, 1>>{residuals} =
          Spline3Pose3CameraLinearReprojectionFactorWithJacobians1234567<Scalar>(
    ...
    case std::uint8_t{0b1111101}: {
      Eigen::Map<Eigen::Matrix<Scalar, 2, 1>>{residuals} =
          Spline3Pose3CameraLinearReprojectionFactorWithJacobians123457<Scalar>(
              lambdas_, _x0, _x1, _x2, _x3, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_,
              sym::kDefaultEpsilon<Scalar>, jacobians[0], jacobians[1], jacobians[2], jacobians[3],
    ...
    case std::uint8_t{0b1111011}: {
      Eigen::Map<Eigen::Matrix<Scalar, 2, 1>>{residuals} =
          Spline3Pose3CameraLinearReprojectionFactorWithJacobians123467<Scalar>(
              lambdas_, _x0, _x1, _x2, _x3, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_,
              sym::kDefaultEpsilon<Scalar>, jacobians[0], jacobians[1], jacobians[2], jacobians[3],
    ...
    case std::uint8_t{0b1111001}: {
      Eigen::Map<Eigen::Matrix<Scalar, 2, 1>>{residuals} =
          Spline3Pose3CameraLinearReprojectionFactorWithJacobians12347<Scalar>(
              lambdas_, _x0, _x1, _x2, _x3, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_,
              sym::kDefaultEpsilon<Scalar>, jacobians[0], jacobians[1], jacobians[2], jacobians[3],
              jacobians[6]);
      return true;
