...
auto Pose2SensorAngleBetweenCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 1, 1>>{residuals} = Pose2SensorAngleBetweenFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 1, 1>>{residuals} =
      Pose2SensorAngleBetweenFactorWithJacobians013<Scalar>(
