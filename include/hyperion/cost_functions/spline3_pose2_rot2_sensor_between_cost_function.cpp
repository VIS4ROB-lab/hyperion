...
auto Spline3Pose2Rot2SensorBetweenCostFunction::evaluate(Scalar const* const* parameters,
                                                         Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 1, 1>>{residuals} =
        Spline3Pose2Rot2SensorBetweenFactor<Scalar>(lambdas_, _x0, _x1, _x2, _x3, _x_T_s, s_T_y_,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 1, 1>>{residuals} =
      Spline3Pose2Rot2SensorBetweenFactorWithJacobians123457<Scalar>(
