...
class Pose3CameraLinearReprojectionCostFunction final
    : public SizedCostFunction<2, ConstexprGroupDims<7, 6>, ConstexprGroupDims<7, 6>,
                               ConstexprGroupDims<4, 4>, ConstexprGroupDims<3, 3>> {
 public:
  /// Constructor.
  explicit Pose3CameraLinearReprojectionCostFunction(const Eigen::Matrix<Scalar, 2, 1>& pixel,
