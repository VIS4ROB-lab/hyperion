...
auto Spline5Rot3PriorCostFunction::evaluate(Scalar const* const* parameters, Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} = Spline5Rot3DeltaFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline5Rot3DeltaFactorWithJacobians123456<Scalar>(
          lambdas_, _x0, _x1, _x2, _x3, _x4, _x5, y_, sqrt_info_, sym::kDefaultEpsilon<Scalar>,
