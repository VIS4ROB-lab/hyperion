...
class Pose2R2SensorPriorCostFunction final
    : public SizedCostFunction<2, ConstexprGroupDims<4, 3>, ConstexprGroupDims<2, 2>> {
 public:
  /// Constructor.
  explicit Pose2R2SensorPriorCostFunction(const sym::Pose2<Scalar>& prior,
