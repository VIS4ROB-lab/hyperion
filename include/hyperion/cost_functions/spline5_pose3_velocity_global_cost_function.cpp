...
auto Spline5Pose3VelocityGlobalCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} = Spline5Pose3VelocityGlobalFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
      Spline5Pose3VelocityGlobalFactorWithJacobians234567<Scalar>(
          dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, _x5, velocity_, sqrt_info_,
