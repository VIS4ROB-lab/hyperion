...
class Spline3Pose2Rot2SensorPriorCostFunction final
    : public SizedCostFunction<1, ConstexprGroupDims<4, 3>, ConstexprGroupDims<4, 3>,
                               ConstexprGroupDims<4, 3>, ConstexprGroupDims<4, 3>,
                               ConstexprGroupDims<2, 1>> {
 public:
  /// Constructor.
  explicit Spline3Pose2Rot2SensorPriorCostFunction(const Eigen::Matrix<Scalar, 3, 1>& lambdas,
