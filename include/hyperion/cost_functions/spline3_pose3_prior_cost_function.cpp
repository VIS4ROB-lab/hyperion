...
auto Spline3Pose3PriorCostFunction::evaluate(Scalar const* const* parameters, Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} = Spline3Pose3DeltaFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
      Spline3Pose3DeltaFactorWithJacobians1234<Scalar>(lambdas_, _x0, _x1, _x2, _x3, y_, sqrt_info_,
