...
auto Spline3Pose2SensorAccelerationGlobalCostFunction::evaluate(Scalar const* const* parameters,
                                                                Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
        Spline3Pose2SensorAccelerationGlobalFactor<Scalar>(dt_, lambdas_, _x0, _x1, _x2, _x3,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline3Pose2SensorAccelerationGlobalFactorWithJacobians23456<Scalar>(
