...
#include "spline4_rot3_velocity_local_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline4_rot3_velocity_local_factor.hpp"
#include "sym/spline4_rot3_velocity_local_factor_with_jacobians23456.hpp"

namespace hyperion {

using namespace sym_hyperion;

auto Spline4Rot3VelocityLocalCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
        Spline4Rot3VelocityLocalFactor<Scalar>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, velocity_,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline4Rot3VelocityLocalFactorWithJacobians23456<Scalar>(
