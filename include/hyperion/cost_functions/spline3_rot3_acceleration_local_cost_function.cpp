...
auto Spline3Rot3AccelerationLocalCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} = Spline3Rot3AccelerationLocalFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline3Rot3AccelerationLocalFactorWithJacobians2345<Scalar>(
