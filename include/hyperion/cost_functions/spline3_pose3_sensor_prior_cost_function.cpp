...
#include "spline3_pose3_sensor_prior_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline3_pose3_sensor_delta_factor.hpp"
#include "sym/spline3_pose3_sensor_delta_factor_with_jacobians12345.hpp"

namespace hyperion {

using namespace sym_hyperion;

auto Spline3Pose3SensorPriorCostFunction::evaluate(Scalar const* const* parameters,
  ...
  const auto _x_T_y = sym::StorageOps<sym::Pose3<Scalar>>::FromStorage(parameters[4]);

  // Evaluation without Jacobians.
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} = Spline3Pose3SensorDeltaFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
      Spline3Pose3SensorDeltaFactorWithJacobians12345<Scalar>(
          lambdas_, _x0, _x1, _x2, _x3, _x_T_y, y_, sqrt_info_, sym::kDefaultEpsilon<Scalar>,
