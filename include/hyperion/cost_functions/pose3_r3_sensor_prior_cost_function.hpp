...
class Pose3R3SensorPriorCostFunction final
    : public SizedCostFunction<3, ConstexprGroupDims<7, 6>, ConstexprGroupDims<3, 3>> {
 public:
  /// Constructor.
  explicit Pose3R3SensorPriorCostFunction(const sym::Pose3<Scalar>& prior,
