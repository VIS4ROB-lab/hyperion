...
class Spline3Rot2AccelerationGlobalCostFunction final
    : public SizedCostFunction<1, ConstexprGroupDims<2, 1>, ConstexprGroupDims<2, 1>,
                               ConstexprGroupDims<2, 1>, ConstexprGroupDims<2, 1>> {
 public:
  /// Constructor.
  explicit Spline3Rot2AccelerationGlobalCostFunction(
      const Scalar dt, const Eigen::Matrix<Scalar, 3, 3>& lambdas,
      const Eigen::Matrix<Scalar, 1, 1>& acceleration, const Eigen::Matrix<Scalar, 1, 1>& sqrtInfo)
  ...
  /// lambdas accessor.
  [[nodiscard]] auto lambdas() const -> const Eigen::Matrix<Scalar, 3, 3>& {
    return lambdas_;
  }

  /// lambdas modifier.
  auto lambdas() -> Eigen::Matrix<Scalar, 3, 3>& {
    return lambdas_;
  }

  /// acceleration accessor.
  [[nodiscard]] auto acceleration() const -> const Eigen::Matrix<Scalar, 1, 1>& {
    return acceleration_;
  }

  /// acceleration modifier.
  auto acceleration() -> Eigen::Matrix<Scalar, 1, 1>& {
    return acceleration_;
  }
 ...
 private:
  Scalar dt_;
  Eigen::Matrix<Scalar, 3, 3> lambdas_;
  Eigen::Matrix<Scalar, 1, 1> acceleration_;
