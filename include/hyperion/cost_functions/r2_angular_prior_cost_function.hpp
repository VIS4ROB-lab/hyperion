...
class R2AngularPriorCostFunction final : public SizedCostFunction<1, ConstexprGroupDims<2, 2>> {
 public:
  /// Constructor.
  explicit R2AngularPriorCostFunction(const Eigen::Matrix<Scalar, 2, 1>& prior,
