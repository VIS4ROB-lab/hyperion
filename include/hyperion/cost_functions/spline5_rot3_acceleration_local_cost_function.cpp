...
auto Spline5Rot3AccelerationLocalCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} = Spline5Rot3AccelerationLocalFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline5Rot3AccelerationLocalFactorWithJacobians234567<Scalar>(
          dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, _x5, acceleration_, sqrt_info_,
