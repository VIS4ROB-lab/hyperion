...
auto Spline3Pose2SensorRelativeBetweenCostFunction::evaluate(Scalar const* const* parameters,
                                                             Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
        Spline3Pose2SensorRelativeBetweenFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline3Pose2SensorRelativeBetweenFactorWithJacobians1234589101112<Scalar>(
          lambdas_x_, _x0, _x1, _x2, _x3, _x_T_a, a_T_b_, lambdas_y_, _y0, _y1, _y2, _y3, _y_T_b,
