...
auto Pose2R2SensorRelativeBetweenCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 2, 1>>{residuals} = Pose2R2SensorRelativeBetweenFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 2, 1>>{residuals} =
      Pose2R2SensorRelativeBetweenFactorWithJacobians0134<Scalar>(
