...
Eigen::Matrix<Scalar, 2, 1> Spline3Pose2R2DeltaFactorWithJacobians1234(
  ...
  if (res_D_x0 != nullptr) {
    ...
    _res_D_x0(0, 0) = 0;
    _res_D_x0(1, 0) = 0;
    _res_D_x0(0, 1) = _tmp2 * sqrt_info(0, 0);
    _res_D_x0(1, 1) = _tmp2 * sqrt_info(1, 0);
    _res_D_x0(0, 2) = _tmp2 * sqrt_info(0, 1);
    _res_D_x0(1, 2) = _tmp2 * sqrt_info(1, 1);
  }
  ...
  if (res_D_x1 != nullptr) {
    ...
    _res_D_x1(0, 0) = 0;
    _res_D_x1(1, 0) = 0;
    _res_D_x1(0, 1) = _tmp3 * sqrt_info(0, 0);
    _res_D_x1(1, 1) = _tmp3 * sqrt_info(1, 0);
    _res_D_x1(0, 2) = _tmp3 * sqrt_info(0, 1);
    _res_D_x1(1, 2) = _tmp3 * sqrt_info(1, 1);
  }
  ...
  if (res_D_x2 != nullptr) {
    ...
    _res_D_x2(0, 0) = 0;
    _res_D_x2(1, 0) = 0;
    _res_D_x2(0, 1) = _tmp4 * sqrt_info(0, 0);
    _res_D_x2(1, 1) = _tmp4 * sqrt_info(1, 0);
    _res_D_x2(0, 2) = _tmp4 * sqrt_info(0, 1);
    _res_D_x2(1, 2) = _tmp4 * sqrt_info(1, 1);
  }
  ...
  if (res_D_x3 != nullptr) {
    ...
    _res_D_x3(0, 0) = 0;
    _res_D_x3(1, 0) = 0;
    _res_D_x3(0, 1) = lambdas(2, 0) * sqrt_info(0, 0);
    _res_D_x3(1, 1) = lambdas(2, 0) * sqrt_info(1, 0);
