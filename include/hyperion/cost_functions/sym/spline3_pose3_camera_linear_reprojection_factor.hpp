...
Eigen::Matrix<Scalar, 2, 1> Spline3Pose3CameraLinearReprojectionFactor(
  ...
  const Scalar _tmp56 = _tmp10 * _tmp53 - _tmp15 * _tmp33 + _tmp25 * _tmp55 + _tmp30 * _tmp31;
  const Scalar _tmp57 =
      2 * _tmp42 * _tmp44 * lambdas(0, 0) * std::sin(_tmp50) / (std::sqrt(_tmp45) * _tmp49);
  const Scalar _tmp58 = _tmp48 * _tmp57;
  const Scalar _tmp59 = _tmp15 * _tmp34 + _tmp24 * _tmp55 - _tmp30 * _tmp35 + _tmp53 * _tmp6;
  const Scalar _tmp60 = _tmp47 * _tmp57;
  const Scalar _tmp61 = _tmp15 * _tmp52 + _tmp29 * _tmp54 - _tmp31 * _tmp34 + _tmp33 * _tmp35;
  const Scalar _tmp62 = _tmp39 * _tmp57;
  const Scalar _tmp63 = _tmp38 * _tmp51 - _tmp56 * _tmp58 - _tmp59 * _tmp60 - _tmp61 * _tmp62;
  const Scalar _tmp64 = _tmp56 * _tmp57;
  const Scalar _tmp65 = _tmp38 * _tmp60 + _tmp39 * _tmp64 + _tmp51 * _tmp59 - _tmp58 * _tmp61;
  const Scalar _tmp66 = _tmp38 * _tmp62 - _tmp47 * _tmp64 + _tmp51 * _tmp61 + _tmp58 * _tmp59;
  const Scalar _tmp67 = _tmp38 * _tmp58 + _tmp51 * _tmp56 - _tmp59 * _tmp62 + _tmp60 * _tmp61;
  const Scalar _tmp68 = _tmp63 * _x0[1] + _tmp65 * _x0[3] - _tmp66 * _x0[0] + _tmp67 * _x0[2];
  const Scalar _tmp69 = _tmp63 * _x0[0] - _tmp65 * _x0[2] + _tmp66 * _x0[1] + _tmp67 * _x0[3];
  const Scalar _tmp70 = _tmp63 * _x0[2] + _tmp65 * _x0[0] + _tmp66 * _x0[3] - _tmp67 * _x0[1];
  const Scalar _tmp71 = _tmp63 * _x0[3] - _tmp65 * _x0[1] - _tmp66 * _x0[2] - _tmp67 * _x0[0];
  const Scalar _tmp72 =
  ...
  const Scalar _tmp75 = 1 - 2 * std::pow(_tmp74, Scalar(2));
  const Scalar _tmp76 = _tmp73 + _tmp75;
  const Scalar _tmp77 =
      -_b_T_c[0] * _tmp68 + _b_T_c[1] * _tmp69 + _b_T_c[2] * _tmp71 + _b_T_c[3] * _tmp70;
  const Scalar _tmp78 = 2 * _tmp74;
  const Scalar _tmp79 = _tmp77 * _tmp78;
  const Scalar _tmp80 = -2 * _b_T_c[0] * _tmp69 - 2 * _b_T_c[1] * _tmp68 - 2 * _b_T_c[2] * _tmp70 +
                        2 * _b_T_c[3] * _tmp71;
  const Scalar _tmp81 = _tmp72 * _tmp80;
  const Scalar _tmp82 = _tmp79 + _tmp81;
  const Scalar _tmp83 = 2 * _tmp72 * _tmp77;
  const Scalar _tmp84 = _tmp74 * _tmp80;
  const Scalar _tmp85 = _tmp83 - _tmp84;
  const Scalar _tmp86 = 2 * _tmp69;
  const Scalar _tmp87 = _tmp70 * _tmp86;
  const Scalar _tmp88 = 2 * _tmp68 * _tmp71;
  const Scalar _tmp89 = 2 * _tmp70;
  const Scalar _tmp90 = _tmp68 * _tmp89;
  const Scalar _tmp91 = _tmp71 * _tmp86;
  const Scalar _tmp92 = -2 * std::pow(_tmp69, Scalar(2));
  const Scalar _tmp93 = -2 * std::pow(_tmp68, Scalar(2));
  const Scalar _tmp94 = _b_T_c[4] * (_tmp87 - _tmp88) + _b_T_c[5] * (_tmp90 + _tmp91) +
                        _b_T_c[6] * (_tmp92 + _tmp93 + 1) + _x0[6] +
                        lambdas(0, 0) * (-_x0[6] + _x1[6]) + lambdas(1, 0) * (-_x1[6] + _x2[6]) +
                        lambdas(2, 0) * (-_x2[6] + _x3[6]);
  const Scalar _tmp95 = _tmp68 * _tmp86;
  const Scalar _tmp96 = _tmp71 * _tmp89;
  const Scalar _tmp97 = 1 - 2 * std::pow(_tmp70, Scalar(2));
  const Scalar _tmp98 = _b_T_c[4] * (_tmp93 + _tmp97) + _b_T_c[5] * (_tmp95 - _tmp96) +
                        _b_T_c[6] * (_tmp87 + _tmp88) + _x0[4] +
                        lambdas(0, 0) * (-_x0[4] + _x1[4]) + lambdas(1, 0) * (-_x1[4] + _x2[4]) +
                        lambdas(2, 0) * (-_x2[4] + _x3[4]);
  const Scalar _tmp99 = _b_T_c[4] * (_tmp95 + _tmp96) + _b_T_c[5] * (_tmp92 + _tmp97) +
                        _b_T_c[6] * (_tmp90 - _tmp91) + _x0[5] +
                        lambdas(0, 0) * (-_x0[5] + _x1[5]) + lambdas(1, 0) * (-_x1[5] + _x2[5]) +
                        lambdas(2, 0) * (-_x2[5] + _x3[5]);
  const Scalar _tmp100 = -_tmp76 * _tmp94 + _tmp76 * l_w(2, 0) - _tmp82 * _tmp98 +
                         _tmp82 * l_w(0, 0) - _tmp85 * _tmp99 + _tmp85 * l_w(1, 0);
  const Scalar _tmp101 = std::max<Scalar>(0, (((_tmp100) > 0) - ((_tmp100) < 0)));
  const Scalar _tmp102 = Scalar(1.0) / (std::max<Scalar>(_tmp100, epsilon));
  const Scalar _tmp103 = -2 * std::pow(_tmp77, Scalar(2));
  const Scalar _tmp104 = _tmp103 + _tmp75;
  const Scalar _tmp105 = _tmp83 + _tmp84;
  const Scalar _tmp106 = _tmp72 * _tmp78;
  const Scalar _tmp107 = _tmp77 * _tmp80;
  const Scalar _tmp108 = _tmp106 - _tmp107;
  const Scalar _tmp109 = _calibration[1] * _tmp102 *
                             (-_tmp104 * _tmp99 + _tmp104 * l_w(1, 0) - _tmp105 * _tmp94 +
                              _tmp105 * l_w(2, 0) - _tmp108 * _tmp98 + _tmp108 * l_w(0, 0)) +
                         _calibration[3] - pixel(1, 0);
  const Scalar _tmp110 = _tmp79 - _tmp81;
  const Scalar _tmp111 = _tmp106 + _tmp107;
  const Scalar _tmp112 = _tmp103 + _tmp73 + 1;
  const Scalar _tmp113 = _calibration[0] * _tmp102 *
                             (-_tmp110 * _tmp94 + _tmp110 * l_w(2, 0) - _tmp111 * _tmp99 +
                              _tmp111 * l_w(1, 0) - _tmp112 * _tmp98 + _tmp112 * l_w(0, 0)) +
                         _calibration[2] - pixel(0, 0);

  // Output terms (1)
  Eigen::Matrix<Scalar, 2, 1> _res;

  _res(0, 0) = _tmp101 * (_tmp109 * sqrt_info(0, 1) + _tmp113 * sqrt_info(0, 0));
  _res(1, 0) = _tmp101 * (_tmp109 * sqrt_info(1, 1) + _tmp113 * sqrt_info(1, 0));
