 ...
 *     res_D_x_T_s: (1x3) jacobian of res (1) wrt arg x_T_s (3)
...
Eigen::Matrix<Scalar, 1, 1> Spline3Pose2Rot2SensorBetweenFactorWithJacobians123457(
  ...
  const Scalar _tmp78 = std::pow(_tmp11, Scalar(2));
  const Scalar _tmp79 = std::pow(_tmp15, Scalar(2));
  const Scalar _tmp80 = Scalar(1.0) / (_tmp79);
  const Scalar _tmp81 = Scalar(1.0) / (_tmp15);
  const Scalar _tmp82 = _tmp79 * lambdas(1, 0) / (_tmp78 + _tmp79);
  const Scalar _tmp83 = _tmp82 * (-_tmp78 * _tmp80 + _tmp81 * (-_tmp12 - _tmp13));
  const Scalar _tmp84 = -_tmp18 * _tmp83 + _tmp21 * _tmp83;
  const Scalar _tmp85 = -_tmp33 * _tmp83 - _tmp34 * _tmp83;
  const Scalar _tmp86 = _tmp64 * (-_tmp25 * _tmp62 * (_tmp23 - _tmp24) + _tmp28 * _tmp63);
  const Scalar _tmp87 = _tmp31 * _tmp84 + _tmp32 * _tmp86 + _tmp36 * _tmp85 - _tmp37 * _tmp86;
  const Scalar _tmp88 = _tmp31 * _tmp85 - _tmp36 * _tmp84 - _tmp40 * _tmp86 - _tmp41 * _tmp86;
  const Scalar _tmp89 = -_tmp87 * _x0[1] + _tmp88 * _x0[0];
  const Scalar _tmp90 = _tmp87 * _x0[0] + _tmp88 * _x0[1];
  const Scalar _tmp91 = _tmp89 * _x_T_s[0] - _tmp90 * _x_T_s[1];
  const Scalar _tmp92 = _tmp89 * _x_T_s[1] + _tmp90 * _x_T_s[0];
  const Scalar _tmp93 = _tmp91 * _y[0] + _tmp92 * _y[1];
  const Scalar _tmp94 = _tmp91 * _y[1] - _tmp92 * _y[0];
  const Scalar _tmp95 = std::pow(_tmp2, Scalar(2));
  const Scalar _tmp96 = std::pow(_tmp6, Scalar(2));
  const Scalar _tmp97 = Scalar(1.0) / (_tmp96);
  const Scalar _tmp98 = Scalar(1.0) / (_tmp6);
  const Scalar _tmp99 = _tmp96 * lambdas(2, 0) / (_tmp95 + _tmp96);
  const Scalar _tmp100 = _tmp99 * (-_tmp95 * _tmp97 + _tmp98 * (-_tmp3 - _tmp4));
  const Scalar _tmp101 = _tmp82 * (-_tmp11 * _tmp80 * (_tmp10 - _tmp9) + _tmp14 * _tmp81);
  const Scalar _tmp102 = -_tmp100 * _tmp33 - _tmp100 * _tmp34 - _tmp101 * _tmp33 - _tmp101 * _tmp34;
  const Scalar _tmp103 = -_tmp100 * _tmp18 + _tmp100 * _tmp21 - _tmp101 * _tmp18 + _tmp101 * _tmp21;
  const Scalar _tmp104 = _tmp102 * _tmp36 + _tmp103 * _tmp31;
  const Scalar _tmp105 = _tmp102 * _tmp31 - _tmp103 * _tmp36;
  const Scalar _tmp106 = _tmp104 * _x0[0] + _tmp105 * _x0[1];
  const Scalar _tmp107 = -_tmp104 * _x0[1] + _tmp105 * _x0[0];
  const Scalar _tmp108 = _tmp106 * _x_T_s[0] + _tmp107 * _x_T_s[1];
  const Scalar _tmp109 = -_tmp106 * _x_T_s[1] + _tmp107 * _x_T_s[0];
  const Scalar _tmp110 = -_tmp108 * _y[0] + _tmp109 * _y[1];
  const Scalar _tmp111 = _tmp108 * _y[1] + _tmp109 * _y[0];
  const Scalar _tmp112 = _tmp99 * (-_tmp2 * _tmp97 * (_tmp0 - _tmp1) + _tmp5 * _tmp98);
  const Scalar _tmp113 = -_tmp112 * _tmp18 + _tmp112 * _tmp21;
  const Scalar _tmp114 = -_tmp112 * _tmp33 - _tmp112 * _tmp34;
  ...
  const Scalar _tmp119 = _tmp117 * _x_T_s[0] + _tmp118 * _x_T_s[1];
  const Scalar _tmp120 = -_tmp117 * _x_T_s[1] + _tmp118 * _x_T_s[0];
  const Scalar _tmp121 = -_tmp119 * _y[0] + _tmp120 * _y[1];
  const Scalar _tmp122 = _tmp119 * _y[1] + _tmp120 * _y[0];
  const Scalar _tmp123 = -_tmp45 - _tmp47;
  const Scalar _tmp124 = _tmp123 * _y[0] + _tmp51;
  const Scalar _tmp125 = _tmp123 * _y[1] - _tmp53;
  ...
  if (res_D_x0 != nullptr) {
    ...
    _res_D_x0(0, 0) = _tmp77 * (_tmp74 * (_s_T_y[0] * _tmp73 - _s_T_y[1] * _tmp72) -
  ...
  if (res_D_x1 != nullptr) {
    ...
    _res_D_x1(0, 0) = _tmp77 * (_tmp74 * (_s_T_y[0] * _tmp94 - _s_T_y[1] * _tmp93) -
                                _tmp76 * (_s_T_y[0] * _tmp93 + _s_T_y[1] * _tmp94));
  }
  ...
  if (res_D_x2 != nullptr) {
    ...
    _res_D_x2(0, 0) = _tmp77 * (_tmp74 * (_s_T_y[0] * _tmp110 - _s_T_y[1] * _tmp111) -
                                _tmp76 * (_s_T_y[0] * _tmp111 + _s_T_y[1] * _tmp110));
  }
  ...
  if (res_D_x3 != nullptr) {
    ...
    _res_D_x3(0, 0) = _tmp77 * (_tmp74 * (_s_T_y[0] * _tmp121 - _s_T_y[1] * _tmp122) -
                                _tmp76 * (_s_T_y[0] * _tmp122 + _s_T_y[1] * _tmp121));
  }

  if (res_D_x_T_s != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 1, 3>> _res_D_x_T_s{res_D_x_T_s};

    _res_D_x_T_s.setZero();

    _res_D_x_T_s(0, 0) = _tmp77 * (_tmp74 * (_s_T_y[0] * _tmp125 - _s_T_y[1] * _tmp124) -
                                   _tmp76 * (_s_T_y[0] * _tmp124 + _s_T_y[1] * _tmp125));
  }
  ...
  if (res_D_y != nullptr) {
    ...
    _res_D_y(0, 0) = _tmp77 * (_tmp74 * (-_s_T_y[1] * _tmp126 + _tmp57) -
                               _tmp76 * (_s_T_y[0] * _tmp126 + _tmp55));
  }
