...
Eigen::Matrix<Scalar, 3, 1> Spline3Pose2SensorBetweenFactor(
  ...
  const Scalar _tmp18 = -_tmp16 * _x_T_s[1] + _tmp17 * _x_T_s[0];
  const Scalar _tmp19 = -_tmp16 * _x_T_s[3] + _tmp17 * _x_T_s[2] + _x0[2] +
                        lambdas(0, 0) * (-_x0[2] + _x1[2]) + lambdas(1, 0) * (-_x1[2] + _x2[2]) +
                        lambdas(2, 0) * (-_x2[2] + _x3[2]);
  const Scalar _tmp20 = _tmp16 * _x_T_s[0] + _tmp17 * _x_T_s[1];
  const Scalar _tmp21 = _tmp16 * _x_T_s[2] + _tmp17 * _x_T_s[3] + _x0[3] +
                        lambdas(0, 0) * (-_x0[3] + _x1[3]) + lambdas(1, 0) * (-_x1[3] + _x2[3]) +
                        lambdas(2, 0) * (-_x2[3] + _x3[3]);
  const Scalar _tmp22 =
      -_s_T_y[2] - _tmp18 * _tmp19 + _tmp18 * _y[2] - _tmp20 * _tmp21 + _tmp20 * _y[3];
  const Scalar _tmp23 =
      -_s_T_y[3] - _tmp18 * _tmp21 + _tmp18 * _y[3] + _tmp19 * _tmp20 - _tmp20 * _y[2];
  const Scalar _tmp24 = _tmp18 * _y[1] - _tmp20 * _y[0];
  const Scalar _tmp25 = _tmp18 * _y[0] + _tmp20 * _y[1];
  const Scalar _tmp26 = _s_T_y[0] * _tmp25 + _s_T_y[1] * _tmp24;
  const Scalar _tmp27 =
      std::atan2(_s_T_y[0] * _tmp24 - _s_T_y[1] * _tmp25,
                 _tmp26 + epsilon * ((((_tmp26) > 0) - ((_tmp26) < 0)) + Scalar(0.5)));

  // Output terms (1)
  Eigen::Matrix<Scalar, 3, 1> _res;

  _res(0, 0) = _tmp22 * sqrt_info(0, 1) + _tmp23 * sqrt_info(0, 2) + _tmp27 * sqrt_info(0, 0);
  _res(1, 0) = _tmp22 * sqrt_info(1, 1) + _tmp23 * sqrt_info(1, 2) + _tmp27 * sqrt_info(1, 0);
  _res(2, 0) = _tmp22 * sqrt_info(2, 1) + _tmp23 * sqrt_info(2, 2) + _tmp27 * sqrt_info(2, 0);
