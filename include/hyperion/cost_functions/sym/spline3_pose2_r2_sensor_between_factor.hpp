...
Eigen::Matrix<Scalar, 2, 1> Spline3Pose2R2SensorBetweenFactor(
    ...
    const sym::Pose2<Scalar>& y, const Eigen::Matrix<Scalar, 2, 2>& sqrt_info,
  ...
  const Scalar _tmp18 = _tmp16 * _x_T_s[0] + _tmp17 * _x_T_s[1];
  ...
  const Scalar _tmp20 = -_tmp16 * _x_T_s[1] + _tmp17 * _x_T_s[0];
  ...
  const Scalar _tmp22 =
      _tmp18 * _tmp19 - _tmp18 * _y[2] - _tmp20 * _tmp21 + _tmp20 * _y[3] - s_T_y(1, 0);
  const Scalar _tmp23 =
      -_tmp18 * _tmp21 + _tmp18 * _y[3] - _tmp19 * _tmp20 + _tmp20 * _y[2] - s_T_y(0, 0);

  // Output terms (1)
  Eigen::Matrix<Scalar, 2, 1> _res;

  _res(0, 0) = _tmp22 * sqrt_info(0, 1) + _tmp23 * sqrt_info(0, 0);
  _res(1, 0) = _tmp22 * sqrt_info(1, 1) + _tmp23 * sqrt_info(1, 0);
