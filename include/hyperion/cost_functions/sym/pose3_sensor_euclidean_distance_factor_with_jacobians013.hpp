...
Eigen::Matrix<Scalar, 1, 1> Pose3SensorEuclideanDistanceFactorWithJacobians013(
  ...
  const Scalar _tmp9 = std::pow(_x[1], Scalar(2));
  const Scalar _tmp10 = 2 * _tmp9;
  const Scalar _tmp11 = -_tmp10;
  const Scalar _tmp12 = std::pow(_x[2], Scalar(2));
  ...
  const Scalar _tmp40 = -_tmp1;
  const Scalar _tmp41 = _tmp3 + _tmp40;
  const Scalar _tmp42 = 2 * _tmp15;
  const Scalar _tmp43 = sqrt_info(0, 0) / _tmp29;
  const Scalar _tmp44 = (Scalar(1) / Scalar(2)) * _tmp43;
  const Scalar _tmp45 = _tmp17 + _tmp37;
  const Scalar _tmp46 = -_tmp12;
  const Scalar _tmp47 = -_tmp6;
  const Scalar _tmp48 = _tmp25 + _tmp47;
  const Scalar _tmp49 = _tmp30 + _tmp46;
  const Scalar _tmp50 = _tmp4 + _tmp40;
  const Scalar _tmp51 = _tmp36 + _tmp9;
  const Scalar _tmp52 = _tmp47 + _tmp7;
  const Scalar _tmp53 = _tmp15 * _tmp43;
  const Scalar _tmp54 = _tmp24 * _tmp43;
  const Scalar _tmp55 = _tmp28 * _tmp43;
  const Scalar _tmp56 = _tmp10 - 1;
  ...
  if (res_D_x != nullptr) {
    ...
    _res_D_x(0, 0) =
        _tmp44 * (_tmp35 * (-_tmp20 * _x_T_s[5] - _x_T_s[6] * (_tmp32 + _tmp34)) +
                  _tmp39 * (-_tmp38 * _x_T_s[6] - _x_T_s[5] * (_tmp12 + _tmp30 + _tmp33 + _tmp36)) +
                  _tmp42 * (-_tmp41 * _x_T_s[6] - _tmp8 * _x_T_s[5]));
    _res_D_x(0, 1) =
        _tmp44 * (_tmp35 * (-_tmp16 * _x_T_s[6] - _tmp45 * _x_T_s[4]) +
                  _tmp39 * (-_tmp26 * _x_T_s[6] - _x_T_s[4] * (_tmp21 + _tmp31 + _tmp46 + _tmp9)) +
                  _tmp42 * (-_tmp48 * _x_T_s[4] - _x_T_s[6] * (_tmp34 + _tmp49)));
    _res_D_x(0, 2) = _tmp44 * (_tmp35 * (-_tmp50 * _x_T_s[5] - _x_T_s[4] * (_tmp49 + _tmp51)) +
                               _tmp39 * (-_tmp27 * _x_T_s[4] - _tmp52 * _x_T_s[5]) +
                               _tmp42 * (-_tmp5 * _x_T_s[4] - _x_T_s[5] * (_tmp32 + _tmp51)));
    _res_D_x(0, 3) = -_tmp53;
    _res_D_x(0, 4) = -_tmp54;
    _res_D_x(0, 5) = -_tmp55;
  }
  ...
  if (res_D_x_T_s != nullptr) {
    ...
    _res_D_x_T_s(0, 1) = 0;
    _res_D_x_T_s(0, 2) = 0;
    _res_D_x_T_s(0, 3) = _tmp44 * (_tmp35 * _tmp50 + _tmp39 * _tmp52 + _tmp42 * (_tmp13 + _tmp56));
    _res_D_x_T_s(0, 4) =
        _tmp44 * (_tmp35 * (_tmp13 + _tmp22 - 1) + _tmp38 * _tmp39 + _tmp41 * _tmp42);
    _res_D_x_T_s(0, 5) = _tmp44 * (_tmp35 * _tmp45 + _tmp39 * (_tmp22 + _tmp56) + _tmp42 * _tmp48);
  }
