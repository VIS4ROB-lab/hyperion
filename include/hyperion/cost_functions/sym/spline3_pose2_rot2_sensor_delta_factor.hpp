...
Eigen::Matrix<Scalar, 1, 1> Spline3Pose2Rot2SensorDeltaFactor(
  ...
  const Scalar _tmp18 = _tmp16 * _y[1] + _tmp17 * _y[0];
  const Scalar _tmp19 = -_tmp16 * _y[0] + _tmp17 * _y[1];
  const Scalar _tmp20 = _tmp18 * _x_T_y[0] + _tmp19 * _x_T_y[1];

  // Output terms (1)
  Eigen::Matrix<Scalar, 1, 1> _res;

  _res(0, 0) = sqrt_info(0, 0) *
               std::atan2(-_tmp18 * _x_T_y[1] + _tmp19 * _x_T_y[0],
