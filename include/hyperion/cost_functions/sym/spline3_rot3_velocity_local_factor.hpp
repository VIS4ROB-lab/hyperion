...
Eigen::Matrix<Scalar, 3, 1> Spline3Rot3VelocityLocalFactor(
  ...
  const Scalar _tmp10 = 2 * lambdas(2, 1);
  ...
  const Scalar _tmp28 = _tmp1 * _tmp27;
  ...
  const Scalar _tmp61 = _tmp37 * _tmp43;
  const Scalar _tmp62 = _tmp49 * _tmp61;
  const Scalar _tmp63 =
      _tmp58 * (-_x0[0] * _x1[1] + _x0[1] * _x1[0] - _x0[2] * _x1[3] + _x0[3] * _x1[2]);
  const Scalar _tmp64 = -_tmp42 * _tmp52;
  const Scalar _tmp65 = -_tmp44 * _tmp52;
  const Scalar _tmp66 =
      _tmp58 * (_x0[0] * _x1[2] - _x0[1] * _x1[3] - _x0[2] * _x1[0] + _x0[3] * _x1[1]);
  const Scalar _tmp67 = 2 * lambdas(1, 1);
  const Scalar _tmp68 = _tmp37 * _tmp67;
  const Scalar _tmp69 = _tmp38 * _tmp68 + _tmp59 * (-_tmp51 + _tmp54) + _tmp63 * (_tmp60 + _tmp62) +
                        _tmp66 * (_tmp64 + _tmp65 + 1);
  const Scalar _tmp70 = -_tmp39 * _tmp52 + 1;
  const Scalar _tmp71 = _tmp38 * _tmp50;
  const Scalar _tmp72 = _tmp30 * _tmp53;
  const Scalar _tmp73 = _tmp59 * (_tmp64 + _tmp70) + _tmp61 * _tmp67 + _tmp63 * (-_tmp71 + _tmp72) +
                        _tmp66 * (_tmp51 + _tmp54);
  const Scalar _tmp74 = -_tmp17 * _tmp27;
  const Scalar _tmp75 = -_tmp13 * _tmp27 + 1;
  const Scalar _tmp76 = _tmp30 * _tmp68 + _tmp59 * (_tmp71 + _tmp72) + _tmp63 * (_tmp65 + _tmp70) +
                        _tmp66 * (_tmp60 - _tmp62);
  const Scalar _tmp77 = _tmp12 * _tmp28;
  const Scalar _tmp78 = _tmp16 * _tmp9;
  const Scalar _tmp79 = _tmp24 * _tmp78;
  const Scalar _tmp80 = _tmp0 * (_tmp1 * _tmp11 + _tmp69 * (_tmp26 + _tmp29) +
                                 _tmp73 * (_tmp74 + _tmp75) + _tmp76 * (_tmp77 - _tmp79)) -
                        velocity(0, 0);
  const Scalar _tmp81 = _tmp1 * _tmp25;
  const Scalar _tmp82 = _tmp12 * _tmp16 * _tmp27;
  const Scalar _tmp83 = -_tmp18 * _tmp27;
  const Scalar _tmp84 = _tmp0 * (_tmp11 * _tmp12 + _tmp69 * (-_tmp81 + _tmp82) +
                                 _tmp73 * (_tmp77 + _tmp79) + _tmp76 * (_tmp74 + _tmp83 + 1)) -
                        velocity(2, 0);
  const Scalar _tmp85 = _tmp0 * (_tmp10 * _tmp78 + _tmp69 * (_tmp75 + _tmp83) +
                                 _tmp73 * (-_tmp26 + _tmp29) + _tmp76 * (_tmp81 + _tmp82)) -
                        velocity(1, 0);

  // Output terms (1)
  Eigen::Matrix<Scalar, 3, 1> _res;

  _res(0, 0) = _tmp80 * sqrt_info(0, 0) + _tmp84 * sqrt_info(0, 2) + _tmp85 * sqrt_info(0, 1);
  _res(1, 0) = _tmp80 * sqrt_info(1, 0) + _tmp84 * sqrt_info(1, 2) + _tmp85 * sqrt_info(1, 1);
  _res(2, 0) = _tmp80 * sqrt_info(2, 0) + _tmp84 * sqrt_info(2, 2) + _tmp85 * sqrt_info(2, 1);
