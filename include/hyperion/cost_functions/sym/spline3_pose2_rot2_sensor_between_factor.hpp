...
Eigen::Matrix<Scalar, 1, 1> Spline3Pose2Rot2SensorBetweenFactor(
  ...
  const Scalar _tmp19 = -_tmp16 * _x_T_s[1] + _tmp17 * _x_T_s[0];
  const Scalar _tmp20 = -_tmp18 * _y[0] + _tmp19 * _y[1];
  const Scalar _tmp21 = _tmp18 * _y[1] + _tmp19 * _y[0];
  const Scalar _tmp22 = _s_T_y[0] * _tmp21 + _s_T_y[1] * _tmp20;

  // Output terms (1)
  Eigen::Matrix<Scalar, 1, 1> _res;

  _res(0, 0) = sqrt_info(0, 0) *
               std::atan2(_s_T_y[0] * _tmp20 - _s_T_y[1] * _tmp21,
