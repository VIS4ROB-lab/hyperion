...
Eigen::Matrix<Scalar, 3, 1> Spline3Pose2AccelerationLocalFactor(
  ...
  const Scalar _tmp25 = _tmp22 * lambdas(2, 1) + _tmp23 * lambdas(1, 1) + _tmp24 * lambdas(0, 1);
  ...
  const Scalar _tmp30 = _tmp27 * lambdas(2, 1) + _tmp28 * lambdas(1, 1) + _tmp29 * lambdas(0, 1);
  const Scalar _tmp31 = _tmp2 * lambdas(2, 1) + _tmp4 * lambdas(1, 1) + _tmp6 * lambdas(0, 1);
  const Scalar _tmp32 = _tmp22 * lambdas(2, 2) + _tmp23 * lambdas(1, 2) + _tmp24 * lambdas(0, 2);
  const Scalar _tmp33 = _tmp27 * lambdas(2, 2) + _tmp28 * lambdas(1, 2) + _tmp29 * lambdas(0, 2);
  const Scalar _tmp34 =
      _tmp0 * (_tmp21 * _tmp33 + _tmp26 * _tmp32 + _tmp31 * (-_tmp21 * _tmp25 + _tmp26 * _tmp30)) -
      acceleration(1, 0);
  const Scalar _tmp35 =
      _tmp0 * (-_tmp21 * _tmp32 + _tmp26 * _tmp33 - _tmp31 * (_tmp21 * _tmp30 + _tmp25 * _tmp26)) -
      acceleration(2, 0);

  // Output terms (1)
  Eigen::Matrix<Scalar, 3, 1> _res;

  _res(0, 0) = _tmp34 * sqrt_info(0, 1) + _tmp35 * sqrt_info(0, 2) + _tmp7 * sqrt_info(0, 0);
  _res(1, 0) = _tmp34 * sqrt_info(1, 1) + _tmp35 * sqrt_info(1, 2) + _tmp7 * sqrt_info(1, 0);
  _res(2, 0) = _tmp34 * sqrt_info(2, 1) + _tmp35 * sqrt_info(2, 2) + _tmp7 * sqrt_info(2, 0);
