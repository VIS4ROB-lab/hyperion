...
Eigen::Matrix<Scalar, 2, 1> Pose3CameraLinearReprojectionFactorWithJacobians0123(
  ...
  const Scalar _tmp46 = 2 * _w_T_b[0] * _w_T_b[3];
  const Scalar _tmp47 = _tmp42 * _w_T_b[2];
  const Scalar _tmp48 = _tmp46 + _tmp47;
  const Scalar _tmp49 = _b_T_c[4] * _tmp45 + _b_T_c[5] * _tmp48 + _b_T_c[6] * _tmp39 + _w_T_b[6];
  const Scalar _tmp50 = std::pow(_w_T_b[2], Scalar(2));
  const Scalar _tmp51 = -2 * _tmp50;
  const Scalar _tmp52 = _tmp36 + _tmp51 + 1;
  const Scalar _tmp53 = _tmp42 * _w_T_b[0];
  const Scalar _tmp54 = _tmp40 * _w_T_b[3];
  const Scalar _tmp55 = -_tmp54;
  const Scalar _tmp56 = _tmp53 + _tmp55;
  const Scalar _tmp57 = _tmp41 + _tmp43;
  const Scalar _tmp58 = _b_T_c[4] * _tmp52 + _b_T_c[5] * _tmp56 + _b_T_c[6] * _tmp57 + _w_T_b[4];
  ...
  const Scalar _tmp63 = _b_T_c[4] * _tmp60 + _b_T_c[5] * _tmp59 + _b_T_c[6] * _tmp62 + _w_T_b[5];
  const Scalar _tmp64 = -_tmp14 * _tmp63 + _tmp14 * l_w(1, 0) - _tmp30 * _tmp58 +
                        _tmp30 * l_w(0, 0) - _tmp34 * _tmp49 + _tmp34 * l_w(2, 0);
  const Scalar _tmp65 = 2 * std::pow(_tmp19, Scalar(2));
  const Scalar _tmp66 = -_tmp65;
  const Scalar _tmp67 = _tmp13 + _tmp66;
  const Scalar _tmp68 = _tmp11 * _tmp27;
  ...
  const Scalar _tmp73 = -_tmp49 * _tmp67 - _tmp58 * _tmp70 - _tmp63 * _tmp72 + _tmp67 * l_w(2, 0) +
  ...
  const Scalar _tmp77 = _calibration[3] + _tmp64 * _tmp76 - pixel(1, 0);
  const Scalar _tmp78 = _tmp6 + _tmp66 + 1;
  const Scalar _tmp79 = -_tmp69;
  const Scalar _tmp80 = _tmp68 + _tmp79;
  const Scalar _tmp81 = _tmp21 + _tmp28;
  const Scalar _tmp82 = -_tmp49 * _tmp80 - _tmp58 * _tmp78 - _tmp63 * _tmp81 + _tmp78 * l_w(0, 0) +
  ...
  const Scalar _tmp124 = _tmp113 * _tmp20 + _tmp123 * _tmp27;
  ...
  const Scalar _tmp136 = _b_T_c[5] * _tmp57 + _b_T_c[6] * (_tmp135 + _tmp54);
  ...
  const Scalar _tmp142 = _b_T_c[5] * _tmp62 + _b_T_c[6] * (_tmp138 + _tmp141);
  const Scalar _tmp143 = -_tmp37;
  const Scalar _tmp144 = -_tmp47;
  const Scalar _tmp145 =
      _b_T_c[5] * (_tmp137 + _tmp139 + _tmp143 + _tmp50) + _b_T_c[6] * (_tmp144 + _tmp61);
  const Scalar _tmp146 = 4 * _tmp19;
  const Scalar _tmp147 = -_tmp123 * _tmp146;
  const Scalar _tmp148 = _tmp127 + _tmp147;
  const Scalar _tmp149 = _tmp20 * _tmp94;
  const Scalar _tmp150 = _tmp103 * _tmp123;
  const Scalar _tmp151 = _tmp102 * _tmp27 + _tmp113 * _tmp32;
  const Scalar _tmp152 = _tmp149 + _tmp150 + _tmp151;
  const Scalar _tmp153 = -_tmp104 + _tmp124 - _tmp95;
  const Scalar _tmp154 = -_tmp136 * _tmp70 - _tmp142 * _tmp72 - _tmp145 * _tmp67 -
                         _tmp148 * _tmp49 + _tmp148 * l_w(2, 0) - _tmp152 * _tmp58 +
                         _tmp152 * l_w(0, 0) - _tmp153 * _tmp63 + _tmp153 * l_w(1, 0);
  const Scalar _tmp155 = (Scalar(1) / Scalar(2)) *
                         ((((_tmp73 - epsilon) > 0) - ((_tmp73 - epsilon) < 0)) + 1) /
                         std::pow(_tmp74, Scalar(2));
  const Scalar _tmp156 = _calibration[1] * _tmp64;
  const Scalar _tmp157 = _tmp155 * _tmp156;
  const Scalar _tmp158 =
      -_tmp154 * _tmp157 + _tmp76 * (-_tmp125 * _tmp49 + _tmp125 * l_w(2, 0) - _tmp130 * _tmp63 +
                                     _tmp130 * l_w(1, 0) - _tmp134 * _tmp58 + _tmp134 * l_w(0, 0) -
  ...
  const Scalar _tmp164 =
      -_tmp154 * _tmp160 + _tmp83 * (-_tmp136 * _tmp78 - _tmp142 * _tmp81 - _tmp145 * _tmp80 -
                                     _tmp161 * _tmp49 + _tmp161 * l_w(2, 0) - _tmp162 * _tmp58 +
                                     _tmp162 * l_w(0, 0) - _tmp163 * _tmp63 + _tmp163 * l_w(1, 0));
  ...
  const Scalar _tmp181 = _tmp170 * _tmp27 + _tmp180 * _tmp20;
  const Scalar _tmp182 = -_tmp175 - _tmp176 + _tmp181;
  const Scalar _tmp183 = _tmp174 * _tmp20;
  const Scalar _tmp184 = _tmp103 * _tmp170;
  const Scalar _tmp185 = _tmp167 * _tmp27 + _tmp180 * _tmp32;
  const Scalar _tmp186 = _tmp183 + _tmp184 + _tmp185;
  const Scalar _tmp187 = -_tmp50;
  const Scalar _tmp188 = _tmp139 + _tmp187;
  const Scalar _tmp189 = -_tmp41;
  const Scalar _tmp190 = _b_T_c[4] * (_tmp189 + _tmp44) + _b_T_c[6] * (_tmp138 + _tmp188);
  const Scalar _tmp191 = _b_T_c[4] * (_tmp144 + _tmp46) + _b_T_c[6] * _tmp60;
  const Scalar _tmp192 = _b_T_c[4] * (_tmp140 + _tmp187 + _tmp35 + _tmp37) + _b_T_c[6] * _tmp45;
  const Scalar _tmp193 = _tmp155 * (-_tmp172 * _tmp49 + _tmp172 * l_w(2, 0) - _tmp182 * _tmp63 +
                                    _tmp182 * l_w(1, 0) - _tmp186 * _tmp58 + _tmp186 * l_w(0, 0) -
                                    _tmp190 * _tmp70 - _tmp191 * _tmp72 - _tmp192 * _tmp67);
  ...
  const Scalar _tmp199 = _tmp167 * _tmp20 + _tmp170 * _tmp32;
  const Scalar _tmp200 = -_tmp197 - _tmp198 + _tmp199;
  const Scalar _tmp201 =
      -_tmp156 * _tmp193 + _tmp76 * (-_tmp14 * _tmp191 - _tmp190 * _tmp30 - _tmp192 * _tmp34 -
                                     _tmp195 * _tmp63 + _tmp195 * l_w(1, 0) - _tmp196 * _tmp49 +
                                     _tmp196 * l_w(2, 0) - _tmp200 * _tmp58 + _tmp200 * l_w(0, 0));
  ...
  const Scalar _tmp205 =
      -_tmp159 * _tmp193 + _tmp83 * (-_tmp190 * _tmp78 - _tmp191 * _tmp81 - _tmp192 * _tmp80 -
                                     _tmp202 * _tmp49 + _tmp202 * l_w(2, 0) - _tmp203 * _tmp58 +
                                     _tmp203 * l_w(0, 0) - _tmp204 * _tmp63 + _tmp204 * l_w(1, 0));
  const Scalar _tmp206 = _b_T_c[4] * _tmp48 + _b_T_c[5] * (_tmp189 + _tmp43);
  const Scalar _tmp207 = _tmp118 + _tmp121 + _tmp166;
  const Scalar _tmp208 = _tmp20 * _tmp207;
  ...
  const Scalar _tmp216 = _tmp212 * _tmp32 + _tmp215 * _tmp27;
  ...
  const Scalar _tmp221 = _tmp207 * _tmp32;
  const Scalar _tmp222 = _tmp103 * _tmp215;
  const Scalar _tmp223 = _tmp20 * _tmp212 + _tmp209 * _tmp27;
  const Scalar _tmp224 = -_tmp221 - _tmp222 + _tmp223;
  const Scalar _tmp225 = _tmp143 + _tmp35;
  const Scalar _tmp226 = _b_T_c[4] * _tmp56 + _b_T_c[5] * (_tmp141 + _tmp225);
  const Scalar _tmp227 = _b_T_c[4] * (_tmp188 + _tmp225) + _b_T_c[5] * (_tmp135 + _tmp55);
  const Scalar _tmp228 = -_tmp206 * _tmp67 - _tmp217 * _tmp58 + _tmp217 * l_w(0, 0) -
                         _tmp220 * _tmp49 + _tmp220 * l_w(2, 0) - _tmp224 * _tmp63 +
  ...
  const Scalar _tmp232 = _tmp20 * _tmp215 + _tmp209 * _tmp32;
  ...
  const Scalar _tmp236 =
      -_tmp160 * _tmp228 + _tmp83 * (-_tmp206 * _tmp80 - _tmp226 * _tmp78 - _tmp227 * _tmp81 -
                                     _tmp229 * _tmp49 + _tmp229 * l_w(2, 0) - _tmp233 * _tmp63 +
                                     _tmp233 * l_w(1, 0) - _tmp235 * _tmp58 + _tmp235 * l_w(0, 0));
  ...
  const Scalar _tmp240 =
      -_tmp157 * _tmp228 + _tmp76 * (-_tmp14 * _tmp227 - _tmp206 * _tmp34 - _tmp226 * _tmp30 -
                                     _tmp237 * _tmp63 + _tmp237 * l_w(1, 0) - _tmp238 * _tmp49 +
                                     _tmp238 * l_w(2, 0) - _tmp239 * _tmp58 + _tmp239 * l_w(0, 0));
  const Scalar _tmp241 = -_tmp68;
  const Scalar _tmp242 = _tmp241 + _tmp79;
  const Scalar _tmp243 = -_tmp21;
  const Scalar _tmp244 = -_tmp157 * _tmp242 + _tmp76 * (_tmp243 + _tmp28);
  const Scalar _tmp245 = _tmp65 - 1;
  const Scalar _tmp246 = -_tmp160 * _tmp242 + _tmp83 * (_tmp245 + _tmp5);
  const Scalar _tmp247 = -_tmp31;
  const Scalar _tmp248 = _tmp247 + _tmp33;
  ...
  const Scalar _tmp255 = _tmp20 * _tmp254;
  ...
  const Scalar _tmp259 = _tmp258 * _tmp32;
  ...
  const Scalar _tmp269 = _tmp20 * _tmp260;
  const Scalar _tmp270 = _tmp256 * _tmp32 + _tmp269;
  ...
  const Scalar _tmp275 = _tmp254 * _tmp32;
  const Scalar _tmp276 = _tmp103 * _tmp260;
  const Scalar _tmp277 = -_tmp276;
  const Scalar _tmp278 = _tmp20 * _tmp258;
  const Scalar _tmp279 = _tmp256 * _tmp27 + _tmp278;
  const Scalar _tmp280 = -_tmp275 + _tmp277 + _tmp279;
  const Scalar _tmp281 = _tmp155 * (-_tmp273 * _tmp49 + _tmp273 * l_w(2, 0) - _tmp274 * _tmp58 +
                                    _tmp274 * l_w(0, 0) - _tmp280 * _tmp63 + _tmp280 * l_w(1, 0));
  const Scalar _tmp282 =
      -_tmp159 * _tmp281 + _tmp83 * (-_tmp263 * _tmp49 + _tmp263 * l_w(2, 0) - _tmp266 * _tmp58 +
                                     _tmp266 * l_w(0, 0) - _tmp271 * _tmp63 + _tmp271 * l_w(1, 0));
  ...
  const Scalar _tmp286 =
      -_tmp156 * _tmp281 + _tmp76 * (-_tmp283 * _tmp49 + _tmp283 * l_w(2, 0) - _tmp284 * _tmp63 +
                                     _tmp284 * l_w(1, 0) - _tmp285 * _tmp58 + _tmp285 * l_w(0, 0));
  const Scalar _tmp287 = _tmp114 + _tmp122 + _tmp165;
  const Scalar _tmp288 = _tmp11 * _tmp287;
  const Scalar _tmp289 = -4 * _tmp288;
  const Scalar _tmp290 = _tmp179 + _tmp86 + _tmp88;
  const Scalar _tmp291 = -_tmp128 * _tmp290;
  const Scalar _tmp292 = _tmp289 + _tmp291;
  const Scalar _tmp293 = _tmp103 * _tmp287;
  const Scalar _tmp294 = _tmp20 * _tmp290 + _tmp261;
  const Scalar _tmp295 = _tmp259 + _tmp293 + _tmp294;
  const Scalar _tmp296 = _tmp258 * _tmp27;
  const Scalar _tmp297 = _tmp103 * _tmp290;
  const Scalar _tmp298 = _tmp260 * _tmp32;
  const Scalar _tmp299 = _tmp20 * _tmp287;
  const Scalar _tmp300 = _tmp298 + _tmp299;
  const Scalar _tmp301 = -_tmp296 - _tmp297 + _tmp300;
  const Scalar _tmp302 = -_tmp146 * _tmp260;
  const Scalar _tmp303 = _tmp289 + _tmp302;
  const Scalar _tmp304 = -_tmp259 - _tmp293 + _tmp294;
  const Scalar _tmp305 = _tmp290 * _tmp32;
  const Scalar _tmp306 = _tmp27 * _tmp287;
  const Scalar _tmp307 = _tmp276 + _tmp306;
  const Scalar _tmp308 = _tmp278 + _tmp305 + _tmp307;
  const Scalar _tmp309 = -_tmp303 * _tmp49 + _tmp303 * l_w(2, 0) - _tmp304 * _tmp63 +
                         _tmp304 * l_w(1, 0) - _tmp308 * _tmp58 + _tmp308 * l_w(0, 0);
  const Scalar _tmp310 =
      -_tmp157 * _tmp309 + _tmp76 * (-_tmp292 * _tmp63 + _tmp292 * l_w(1, 0) - _tmp295 * _tmp49 +
                                     _tmp295 * l_w(2, 0) - _tmp301 * _tmp58 + _tmp301 * l_w(0, 0));
  const Scalar _tmp311 = _tmp277 - _tmp278 + _tmp305 + _tmp306;
  const Scalar _tmp312 = _tmp291 + _tmp302;
  const Scalar _tmp313 = _tmp296 + _tmp297 + _tmp300;
  const Scalar _tmp314 =
      -_tmp160 * _tmp309 + _tmp83 * (-_tmp311 * _tmp49 + _tmp311 * l_w(2, 0) - _tmp312 * _tmp58 +
                                     _tmp312 * l_w(0, 0) - _tmp313 * _tmp63 + _tmp313 * l_w(1, 0));
  const Scalar _tmp315 = _tmp105 + _tmp107 + _tmp214;
  const Scalar _tmp316 = _tmp27 * _tmp315;
  const Scalar _tmp317 = _tmp103 * _tmp254;
  const Scalar _tmp318 = _tmp300 + _tmp316 + _tmp317;
  const Scalar _tmp319 = -_tmp126 * _tmp315;
  const Scalar _tmp320 = -_tmp146 * _tmp254;
  const Scalar _tmp321 = _tmp319 + _tmp320;
  const Scalar _tmp322 = 2 * _tmp288;
  const Scalar _tmp323 = _tmp103 * _tmp315;
  const Scalar _tmp324 = _tmp267 + _tmp269;
  const Scalar _tmp325 = -_tmp322 - _tmp323 + _tmp324;
  const Scalar _tmp326 = -_tmp318 * _tmp58 + _tmp318 * l_w(0, 0) - _tmp321 * _tmp49 +
                         _tmp321 * l_w(2, 0) - _tmp325 * _tmp63 + _tmp325 * l_w(1, 0);
  const Scalar _tmp327 = _tmp298 - _tmp299 + _tmp316 - _tmp317;
  const Scalar _tmp328 = _tmp20 * _tmp315 + _tmp275;
  const Scalar _tmp329 = _tmp307 + _tmp328;
  const Scalar _tmp330 = -_tmp128 * _tmp260;
  const Scalar _tmp331 = _tmp320 + _tmp330;
  const Scalar _tmp332 =
      -_tmp160 * _tmp326 + _tmp83 * (-_tmp327 * _tmp49 + _tmp327 * l_w(2, 0) - _tmp329 * _tmp63 +
                                     _tmp329 * l_w(1, 0) - _tmp331 * _tmp58 + _tmp331 * l_w(0, 0));
  const Scalar _tmp333 = _tmp319 + _tmp330;
  const Scalar _tmp334 = _tmp322 + _tmp323 + _tmp324;
  const Scalar _tmp335 = _tmp277 - _tmp306 + _tmp328;
  const Scalar _tmp336 =
      -_tmp157 * _tmp326 + _tmp76 * (-_tmp333 * _tmp63 + _tmp333 * l_w(1, 0) - _tmp334 * _tmp49 +
                                     _tmp334 * l_w(2, 0) - _tmp335 * _tmp58 + _tmp335 * l_w(0, 0));
  const Scalar _tmp337 = -_tmp45 * _tmp67 - _tmp52 * _tmp70 - _tmp60 * _tmp72;
  const Scalar _tmp338 =
      -_tmp157 * _tmp337 + _tmp76 * (-_tmp14 * _tmp60 - _tmp30 * _tmp52 - _tmp34 * _tmp45);
  const Scalar _tmp339 =
      -_tmp160 * _tmp337 + _tmp83 * (-_tmp45 * _tmp80 - _tmp52 * _tmp78 - _tmp60 * _tmp81);
  const Scalar _tmp340 = -_tmp48 * _tmp67 - _tmp56 * _tmp70 - _tmp59 * _tmp72;
  const Scalar _tmp341 =
      -_tmp157 * _tmp340 + _tmp76 * (-_tmp14 * _tmp59 - _tmp30 * _tmp56 - _tmp34 * _tmp48);
  const Scalar _tmp342 =
      -_tmp160 * _tmp340 + _tmp83 * (-_tmp48 * _tmp80 - _tmp56 * _tmp78 - _tmp59 * _tmp81);
  const Scalar _tmp343 = -_tmp39 * _tmp67 - _tmp57 * _tmp70 - _tmp62 * _tmp72;
  const Scalar _tmp344 =
      -_tmp157 * _tmp343 + _tmp76 * (-_tmp14 * _tmp62 - _tmp30 * _tmp57 - _tmp34 * _tmp39);
  const Scalar _tmp345 =
      -_tmp160 * _tmp343 + _tmp83 * (-_tmp39 * _tmp80 - _tmp57 * _tmp78 - _tmp62 * _tmp81);
  const Scalar _tmp346 = _tmp85 * sqrt_info(0, 0);
  const Scalar _tmp347 = _tmp75 * _tmp82;
  const Scalar _tmp348 = _tmp85 * sqrt_info(1, 0);
  const Scalar _tmp349 = _tmp85 * sqrt_info(0, 1);
  const Scalar _tmp350 = _tmp64 * _tmp75;
  const Scalar _tmp351 = _tmp85 * sqrt_info(1, 1);
  const Scalar _tmp352 = -_tmp157 * _tmp70 + _tmp30 * _tmp76;
  const Scalar _tmp353 = -_tmp160 * _tmp70 + _tmp78 * _tmp83;
  const Scalar _tmp354 = -_tmp160 * _tmp72 + _tmp81 * _tmp83;
  const Scalar _tmp355 = _tmp14 * _tmp76 - _tmp157 * _tmp72;
  const Scalar _tmp356 = -_tmp160 * _tmp67 + _tmp80 * _tmp83;
  const Scalar _tmp357 = -_tmp157 * _tmp67 + _tmp34 * _tmp76;
  ...
  if (res_D_b_T_c != nullptr) {
    ...
    _res_D_b_T_c(0, 1) = _tmp85 * (_tmp310 * sqrt_info(0, 1) + _tmp314 * sqrt_info(0, 0));
    _res_D_b_T_c(1, 1) = _tmp85 * (_tmp310 * sqrt_info(1, 1) + _tmp314 * sqrt_info(1, 0));
    _res_D_b_T_c(0, 2) = _tmp85 * (_tmp332 * sqrt_info(0, 0) + _tmp336 * sqrt_info(0, 1));
    _res_D_b_T_c(1, 2) = _tmp85 * (_tmp332 * sqrt_info(1, 0) + _tmp336 * sqrt_info(1, 1));
    _res_D_b_T_c(0, 3) = _tmp85 * (_tmp338 * sqrt_info(0, 1) + _tmp339 * sqrt_info(0, 0));
    _res_D_b_T_c(1, 3) = _tmp85 * (_tmp338 * sqrt_info(1, 1) + _tmp339 * sqrt_info(1, 0));
    _res_D_b_T_c(0, 4) = _tmp85 * (_tmp341 * sqrt_info(0, 1) + _tmp342 * sqrt_info(0, 0));
    _res_D_b_T_c(1, 4) = _tmp85 * (_tmp341 * sqrt_info(1, 1) + _tmp342 * sqrt_info(1, 0));
    _res_D_b_T_c(0, 5) = _tmp85 * (_tmp344 * sqrt_info(0, 1) + _tmp345 * sqrt_info(0, 0));
    _res_D_b_T_c(1, 5) = _tmp85 * (_tmp344 * sqrt_info(1, 1) + _tmp345 * sqrt_info(1, 0));
  }

  if (res_D_calibration != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 2, 4>> _res_D_calibration{res_D_calibration};

    _res_D_calibration(0, 0) = _tmp346 * _tmp347;
    _res_D_calibration(1, 0) = _tmp347 * _tmp348;
    _res_D_calibration(0, 1) = _tmp349 * _tmp350;
    _res_D_calibration(1, 1) = _tmp350 * _tmp351;
    _res_D_calibration(0, 2) = _tmp346;
    _res_D_calibration(1, 2) = _tmp348;
    _res_D_calibration(0, 3) = _tmp349;
    _res_D_calibration(1, 3) = _tmp351;
  }

  if (res_D_l_w != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 2, 3>> _res_D_l_w{res_D_l_w};

    _res_D_l_w(0, 0) = _tmp85 * (_tmp352 * sqrt_info(0, 1) + _tmp353 * sqrt_info(0, 0));
    _res_D_l_w(1, 0) = _tmp85 * (_tmp352 * sqrt_info(1, 1) + _tmp353 * sqrt_info(1, 0));
    _res_D_l_w(0, 1) = _tmp85 * (_tmp354 * sqrt_info(0, 0) + _tmp355 * sqrt_info(0, 1));
    _res_D_l_w(1, 1) = _tmp85 * (_tmp354 * sqrt_info(1, 0) + _tmp355 * sqrt_info(1, 1));
    _res_D_l_w(0, 2) = _tmp85 * (_tmp356 * sqrt_info(0, 0) + _tmp357 * sqrt_info(0, 1));
    _res_D_l_w(1, 2) = _tmp85 * (_tmp356 * sqrt_info(1, 0) + _tmp357 * sqrt_info(1, 1));
  }
