...
Eigen::Matrix<Scalar, 1, 1> Spline3Pose2Rot2SensorDeltaFactorWithJacobians12345(
  ...
  const Scalar _tmp71 = std::pow(_tmp11, Scalar(2));
  const Scalar _tmp72 = std::pow(_tmp15, Scalar(2));
  const Scalar _tmp73 = Scalar(1.0) / (_tmp72);
  const Scalar _tmp74 = Scalar(1.0) / (_tmp15);
  const Scalar _tmp75 = _tmp72 * lambdas(1, 0) / (_tmp71 + _tmp72);
  const Scalar _tmp76 = _tmp75 * (-_tmp71 * _tmp73 + _tmp74 * (-_tmp12 - _tmp13));
  const Scalar _tmp77 = -_tmp18 * _tmp76 + _tmp21 * _tmp76;
  const Scalar _tmp78 = -_tmp33 * _tmp76 - _tmp34 * _tmp76;
  const Scalar _tmp79 = _tmp57 * (-_tmp25 * _tmp55 * (_tmp23 - _tmp24) + _tmp28 * _tmp56);
  ...
  const Scalar _tmp84 = -_tmp82 * _y[0] + _tmp83 * _y[1];
  const Scalar _tmp85 = _tmp82 * _y[1] + _tmp83 * _y[0];
  const Scalar _tmp86 = std::pow(_tmp2, Scalar(2));
  const Scalar _tmp87 = std::pow(_tmp6, Scalar(2));
  const Scalar _tmp88 = Scalar(1.0) / (_tmp87);
  const Scalar _tmp89 = Scalar(1.0) / (_tmp6);
  const Scalar _tmp90 = -_tmp86 * _tmp88 + _tmp89 * (-_tmp3 - _tmp4);
  const Scalar _tmp91 = _tmp87 * lambdas(2, 0) / (_tmp86 + _tmp87);
  const Scalar _tmp92 = _tmp90 * _tmp91;
  const Scalar _tmp93 = _tmp75 * (-_tmp11 * _tmp73 * (_tmp10 - _tmp9) + _tmp14 * _tmp74);
  const Scalar _tmp94 = -_tmp33 * _tmp92 - _tmp33 * _tmp93 - _tmp34 * _tmp92 - _tmp34 * _tmp93;
  const Scalar _tmp95 = _tmp21 * _tmp91;
  const Scalar _tmp96 = -_tmp18 * _tmp92 - _tmp18 * _tmp93 + _tmp21 * _tmp93 + _tmp90 * _tmp95;
  const Scalar _tmp97 = _tmp31 * _tmp96 + _tmp36 * _tmp94;
  const Scalar _tmp98 = _tmp31 * _tmp94 - _tmp36 * _tmp96;
  ...
  const Scalar _tmp103 = -_tmp2 * _tmp88 * (_tmp0 - _tmp1) + _tmp5 * _tmp89;
  const Scalar _tmp104 = _tmp103 * _tmp91;
  const Scalar _tmp105 = _tmp103 * _tmp95 - _tmp104 * _tmp18;
  ...
  if (res_D_x0 != nullptr) {
    ...
    _res_D_x0(0, 0) = _tmp70 * (-_tmp67 * (_tmp63 * _x_T_y[0] + _tmp64 * _x_T_y[1]) +
  ...
  if (res_D_x1 != nullptr) {
    ...
    _res_D_x1(0, 0) = _tmp70 * (-_tmp67 * (_tmp84 * _x_T_y[1] + _tmp85 * _x_T_y[0]) +
                                _tmp68 * (_tmp84 * _x_T_y[0] - _tmp85 * _x_T_y[1]));
  }
  ...
  if (res_D_x2 != nullptr) {
    ...
    _res_D_x2(0, 0) = _tmp70 * (-_tmp67 * (_tmp101 * _x_T_y[1] + _tmp102 * _x_T_y[0]) +
  ...
  if (res_D_x3 != nullptr) {
    ...
    _res_D_x3(0, 0) = _tmp70 * (-_tmp67 * (_tmp111 * _x_T_y[0] + _tmp112 * _x_T_y[1]) +
  ...
  if (res_D_x_T_y != nullptr) {
    ...
    _res_D_x_T_y(0, 0) = _tmp70 * (-_tmp66 * _tmp69 + _tmp68 * (-_tmp49 - _tmp50));
  }
