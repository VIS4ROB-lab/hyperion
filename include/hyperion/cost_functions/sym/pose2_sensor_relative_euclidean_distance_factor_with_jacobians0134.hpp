...
Eigen::Matrix<Scalar, 1, 1> Pose2SensorRelativeEuclideanDistanceFactorWithJacobians0134(
  ...
  const Scalar _tmp13 = _tmp11 * _tmp7;
  ...
  if (res_D_x != nullptr) {
    ...
    _res_D_x(0, 0) = _tmp12 * (_tmp0 * _tmp10 + _tmp9 * (_tmp4 - _tmp5));
    _res_D_x(0, 1) = -_tmp13;
    _res_D_x(0, 2) = -_tmp14;
  }
  ...
  if (res_D_x_T_a != nullptr) {
    ...
    _res_D_x_T_a(0, 0) = 0;
    _res_D_x_T_a(0, 1) = _tmp12 * (-_tmp10 * _x[0] - _tmp9 * _x[1]);
    _res_D_x_T_a(0, 2) = _tmp12 * (_tmp10 * _x[1] - _tmp9 * _x[0]);
  }

  if (res_D_y != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 1, 3>> _res_D_y{res_D_y};

    _res_D_y(0, 0) = _tmp12 * (_tmp10 * (-_tmp1 - _tmp2) + _tmp6 * _tmp9);
    _res_D_y(0, 1) = _tmp13;
    _res_D_y(0, 2) = _tmp14;
  }
  ...
  if (res_D_y_T_b != nullptr) {
    ...
    _res_D_y_T_b(0, 0) = 0;
    _res_D_y_T_b(0, 1) = _tmp12 * (_tmp10 * _y[0] + _tmp9 * _y[1]);
    _res_D_y_T_b(0, 2) = _tmp12 * (-_tmp10 * _y[1] + _tmp9 * _y[0]);
  }
