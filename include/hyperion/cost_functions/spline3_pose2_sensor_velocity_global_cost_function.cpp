...
auto Spline3Pose2SensorVelocityGlobalCostFunction::evaluate(Scalar const* const* parameters,
                                                            Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
        Spline3Pose2SensorVelocityGlobalFactor<Scalar>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x_T_s,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline3Pose2SensorVelocityGlobalFactorWithJacobians23456<Scalar>(
