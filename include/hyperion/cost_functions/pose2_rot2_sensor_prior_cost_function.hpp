...
class Pose2Rot2SensorPriorCostFunction final
    : public SizedCostFunction<1, ConstexprGroupDims<4, 3>, ConstexprGroupDims<2, 1>> {
 public:
  /// Constructor.
  explicit Pose2Rot2SensorPriorCostFunction(const sym::Pose2<Scalar>& prior,
