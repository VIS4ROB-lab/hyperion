...
#include "spline3_pose2_acceleration_global_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline3_pose2_acceleration_global_factor.hpp"
#include "sym/spline3_pose2_acceleration_global_factor_with_jacobians2345.hpp"

namespace hyperion {

using namespace sym_hyperion;

auto Spline3Pose2AccelerationGlobalCostFunction::evaluate(Scalar const* const* parameters,
                                                          Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
        Spline3Pose2AccelerationGlobalFactor<Scalar>(dt_, lambdas_, _x0, _x1, _x2, _x3,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline3Pose2AccelerationGlobalFactorWithJacobians2345<Scalar>(
