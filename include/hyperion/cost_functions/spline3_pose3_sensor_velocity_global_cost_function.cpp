...
auto Spline3Pose3SensorVelocityGlobalCostFunction::evaluate(Scalar const* const* parameters,
                                                            Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
        Spline3Pose3SensorVelocityGlobalFactor<Scalar>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x_T_s,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
      Spline3Pose3SensorVelocityGlobalFactorWithJacobians23456<Scalar>(
