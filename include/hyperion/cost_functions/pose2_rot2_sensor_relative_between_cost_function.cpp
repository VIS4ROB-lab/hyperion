...
#include "pose2_rot2_sensor_relative_between_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/pose2_rot2_sensor_relative_between_factor.hpp"
#include "sym/pose2_rot2_sensor_relative_between_factor_with_jacobians0134.hpp"

namespace hyperion {

using namespace sym_hyperion;

auto Pose2Rot2SensorRelativeBetweenCostFunction::evaluate(Scalar const* const* parameters,
                                                          Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 1, 1>>{residuals} =
        Pose2Rot2SensorRelativeBetweenFactor<Scalar>(_x, _x_T_a, a_T_b_, _y, _y_T_b, sqrt_info_,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 1, 1>>{residuals} =
      Pose2Rot2SensorRelativeBetweenFactorWithJacobians0134<Scalar>(
