...
#include "spline3_rot3_velocity_local_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline3_rot3_velocity_local_factor.hpp"
#include "sym/spline3_rot3_velocity_local_factor_with_jacobians2345.hpp"

namespace hyperion {

using namespace sym_hyperion;

auto Spline3Rot3VelocityLocalCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} = Spline3Rot3VelocityLocalFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline3Rot3VelocityLocalFactorWithJacobians2345<Scalar>(
          dt_, lambdas_, _x0, _x1, _x2, _x3, velocity_, sqrt_info_, sym::kDefaultEpsilon<Scalar>,
