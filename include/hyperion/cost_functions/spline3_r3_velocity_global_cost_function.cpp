...
auto Spline3R3VelocityGlobalCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} = Spline3R3VelocityGlobalFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline3R3VelocityGlobalFactorWithJacobians2345<Scalar>(
          dt_, lambdas_, _x0, _x1, _x2, _x3, velocity_, sqrt_info_, sym::kDefaultEpsilon<Scalar>,
