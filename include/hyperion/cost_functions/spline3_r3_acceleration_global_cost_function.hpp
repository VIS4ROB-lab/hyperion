...
class Spline3R3AccelerationGlobalCostFunction final
    : public SizedCostFunction<3, ConstexprGroupDims<3, 3>, ConstexprGroupDims<3, 3>,
                               ConstexprGroupDims<3, 3>, ConstexprGroupDims<3, 3>> {
 public:
  /// Constructor.
  explicit Spline3R3AccelerationGlobalCostFunction(const Scalar dt,
