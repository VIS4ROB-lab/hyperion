...
class R3AngularPriorCostFunction final : public SizedCostFunction<1, ConstexprGroupDims<3, 3>> {
 public:
  /// Constructor.
  explicit R3AngularPriorCostFunction(const Eigen::Matrix<Scalar, 3, 1>& prior,
