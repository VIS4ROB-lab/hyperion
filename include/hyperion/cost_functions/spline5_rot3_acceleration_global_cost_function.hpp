...
class Spline5Rot3AccelerationGlobalCostFunction final
    : public SizedCostFunction<3, ConstexprGroupDims<4, 3>, ConstexprGroupDims<4, 3>,
                               ConstexprGroupDims<4, 3>, ConstexprGroupDims<4, 3>,
                               ConstexprGroupDims<4, 3>, ConstexprGroupDims<4, 3>> {
 public:
  /// Constructor.
  explicit Spline5Rot3AccelerationGlobalCostFunction(
      const Scalar dt, const Eigen::Matrix<Scalar, 5, 3>& lambdas,
      const Eigen::Matrix<Scalar, 3, 1>& acceleration, const Eigen::Matrix<Scalar, 3, 3>& sqrtInfo)
  ...
  /// lambdas accessor.
  [[nodiscard]] auto lambdas() const -> const Eigen::Matrix<Scalar, 5, 3>& {
    return lambdas_;
  }

  /// lambdas modifier.
  auto lambdas() -> Eigen::Matrix<Scalar, 5, 3>& {
    return lambdas_;
  }
 ...
 private:
  Scalar dt_;
  Eigen::Matrix<Scalar, 5, 3> lambdas_;
