...
auto Spline4Pose3VelocityGlobalCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
        Spline4Pose3VelocityGlobalFactor<Scalar>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, velocity_,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
      Spline4Pose3VelocityGlobalFactorWithJacobians23456<Scalar>(
