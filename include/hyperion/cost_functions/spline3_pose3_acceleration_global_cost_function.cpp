...
auto Spline3Pose3AccelerationGlobalCostFunction::evaluate(Scalar const* const* parameters,
                                                          Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
        Spline3Pose3AccelerationGlobalFactor<Scalar>(dt_, lambdas_, _x0, _x1, _x2, _x3,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
      Spline3Pose3AccelerationGlobalFactorWithJacobians2345<Scalar>(
