...
auto Spline3R3AccelerationLocalCostFunction::evaluate(Scalar const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} = Spline3R3AccelerationLocalFactor<Scalar>(
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 3, 1>>{residuals} =
      Spline3R3AccelerationLocalFactorWithJacobians2345<Scalar>(
