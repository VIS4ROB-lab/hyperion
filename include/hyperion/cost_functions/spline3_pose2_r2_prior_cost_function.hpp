...
class Spline3Pose2R2PriorCostFunction final
    : public SizedCostFunction<2, ConstexprGroupDims<4, 3>, ConstexprGroupDims<4, 3>,
                               ConstexprGroupDims<4, 3>, ConstexprGroupDims<4, 3>> {
 public:
  /// Constructor.
  explicit Spline3Pose2R2PriorCostFunction(const Eigen::Matrix<Scalar, 3, 1>& lambdas,
                                           const Eigen::Matrix<Scalar, 2, 1>& prior,
