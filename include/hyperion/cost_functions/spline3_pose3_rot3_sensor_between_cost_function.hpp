...
class Spline3Pose3Rot3SensorBetweenCostFunction final
 ...
 public:
  /// Constructor.
  explicit Spline3Pose3Rot3SensorBetweenCostFunction(const Eigen::Matrix<Scalar, 3, 1>& lambdas,
                                                     const sym::Rot3<Scalar>& sTy,
  ...
  /// sTy accessor.
  [[nodiscard]] auto sTy() const -> const sym::Rot3<Scalar>& {
    return s_T_y_;
  }

  /// sTy modifier.
  auto sTy() -> sym::Rot3<Scalar>& {
    return s_T_y_;
  }
