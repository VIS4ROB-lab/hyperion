...
class Spline3Pose3SensorBetweenCostFunction final
    : public SizedCostFunction<6, ConstexprGroupDims<7, 6>, ConstexprGroupDims<7, 6>,
                               ConstexprGroupDims<7, 6>, ConstexprGroupDims<7, 6>,
                               ConstexprGroupDims<7, 6>, ConstexprGroupDims<7, 6>> {
 public:
  /// Constructor.
  explicit Spline3Pose3SensorBetweenCostFunction(const Eigen::Matrix<Scalar, 3, 1>& lambdas,
                                                 const sym::Pose3<Scalar>& sTy,
