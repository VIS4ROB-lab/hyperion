...
#include "spline3_pose3_acceleration_local_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline3_pose3_acceleration_local_factor.hpp"
#include "sym/spline3_pose3_acceleration_local_factor_with_jacobians2345.hpp"

namespace hyperion {

using namespace sym_hyperion;

auto Spline3Pose3AccelerationLocalCostFunction::evaluate(Scalar const* const* parameters,
                                                         Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
        Spline3Pose3AccelerationLocalFactor<Scalar>(dt_, lambdas_, _x0, _x1, _x2, _x3,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
      Spline3Pose3AccelerationLocalFactorWithJacobians2345<Scalar>(
