...
class Spline3Rot2AccelerationLocalCostFunction final
    : public SizedCostFunction<1, ConstexprGroupDims<2, 1>, ConstexprGroupDims<2, 1>,
                               ConstexprGroupDims<2, 1>, ConstexprGroupDims<2, 1>> {
 public:
  /// Constructor.
  explicit Spline3Rot2AccelerationLocalCostFunction(const Scalar dt,
                                                    const Eigen::Matrix<Scalar, 3, 3>& lambdas,
                                                    const Eigen::Matrix<Scalar, 1, 1>& acceleration,
