...
auto Spline4Pose3AccelerationGlobalCostFunction::evaluate(Scalar const* const* parameters,
                                                          Scalar* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
        Spline4Pose3AccelerationGlobalFactor<Scalar>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x4,
  ...
  Eigen::Map<Eigen::Matrix<Scalar, 6, 1>>{residuals} =
      Spline4Pose3AccelerationGlobalFactorWithJacobians23456<Scalar>(
