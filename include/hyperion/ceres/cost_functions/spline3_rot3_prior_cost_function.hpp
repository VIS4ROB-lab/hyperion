...
class Spline3Rot3PriorCostFunction final : public ::ceres::SizedCostFunction<3, 4, 4, 4, 4> {
 public:
  /// Constructor.
  explicit Spline3Rot3PriorCostFunction(const Eigen::Matrix<double, 3, 1>& lambdas,
