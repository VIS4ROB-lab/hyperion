...
class R3AngularDistanceCostFunction final : public ::ceres::SizedCostFunction<1, 3, 3> {
 public:
  /// Constructor.
  explicit R3AngularDistanceCostFunction(const Eigen::Matrix<double, 1, 1>& xdy,
