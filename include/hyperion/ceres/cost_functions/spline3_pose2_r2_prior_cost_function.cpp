...
auto Spline3Pose2R2PriorCostFunction::Evaluate(double const* const* parameters, double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 2, 1>>{residuals} = Spline3Pose2R2DeltaFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 2, 1>>{residuals} =
      Spline3Pose2R2DeltaFactorWithJacobians1234<double>(
