...
auto Spline3Rot2AccelerationLocalCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} = Spline3Rot2AccelerationLocalFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
      Spline3Rot2AccelerationLocalFactorWithJacobians2345<double>(
