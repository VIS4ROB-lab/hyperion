...
class Spline3R3PriorCostFunction final : public ::ceres::SizedCostFunction<3, 3, 3, 3, 3> {
 public:
  /// Constructor.
  explicit Spline3R3PriorCostFunction(const Eigen::Matrix<double, 3, 1>& lambdas,
