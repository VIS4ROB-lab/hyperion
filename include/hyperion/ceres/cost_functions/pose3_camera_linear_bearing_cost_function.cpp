...
auto Pose3CameraLinearBearingCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} = Pose3CameraLinearBearingFactor<double>(
  ...
  switch (bits | std::uint8_t{0b1001}) {
    case std::uint8_t{0b1111}: {
      Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
          Pose3CameraLinearBearingFactorWithJacobians0123<double>(
              _w_T_b, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_, sym::kDefaultEpsilon<double>,
    ...
    case std::uint8_t{0b1101}: {
      Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
          Pose3CameraLinearBearingFactorWithJacobians013<double>(
              _w_T_b, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_, sym::kDefaultEpsilon<double>,
    ...
    case std::uint8_t{0b1011}: {
      Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
          Pose3CameraLinearBearingFactorWithJacobians023<double>(
              _w_T_b, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_, sym::kDefaultEpsilon<double>,
    ...
    case std::uint8_t{0b1001}: {
      Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
          Pose3CameraLinearBearingFactorWithJacobians03<double>(
              _w_T_b, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_, sym::kDefaultEpsilon<double>,
