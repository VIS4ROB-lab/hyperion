...
class Spline5Rot3PriorCostFunction final : public ::ceres::SizedCostFunction<3, 4, 4, 4, 4, 4, 4> {
 public:
  /// Constructor.
  explicit Spline5Rot3PriorCostFunction(const Eigen::Matrix<double, 5, 1>& lambdas,
