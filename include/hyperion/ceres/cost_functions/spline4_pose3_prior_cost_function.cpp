...
#include "spline4_pose3_prior_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline4_pose3_delta_factor.hpp"
#include "sym/spline4_pose3_delta_factor_with_jacobians12345.hpp"

namespace hyperion::ceres {

using namespace sym_ceres;

auto Spline4Pose3PriorCostFunction::Evaluate(double const* const* parameters, double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} = Spline4Pose3DeltaFactor<double>(
        lambdas_, _x0, _x1, _x2, _x3, _x4, y_, sqrt_info_, sym::kDefaultEpsilon<double>);
    return true;
  }

  // Evaluation with Jacobians.
  Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
      Spline4Pose3DeltaFactorWithJacobians12345<double>(
          lambdas_, _x0, _x1, _x2, _x3, _x4, y_, sqrt_info_, sym::kDefaultEpsilon<double>,
