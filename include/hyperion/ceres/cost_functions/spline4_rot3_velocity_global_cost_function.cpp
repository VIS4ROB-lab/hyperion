...
auto Spline4Rot3VelocityGlobalCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
        Spline4Rot3VelocityGlobalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, velocity_,
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline4Rot3VelocityGlobalFactorWithJacobians23456<double>(
