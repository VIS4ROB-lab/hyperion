...
auto Spline4Pose3AccelerationLocalCostFunction::Evaluate(double const* const* parameters,
                                                         double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
        Spline4Pose3AccelerationLocalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x4,
  ...
  Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
      Spline4Pose3AccelerationLocalFactorWithJacobians23456<double>(
