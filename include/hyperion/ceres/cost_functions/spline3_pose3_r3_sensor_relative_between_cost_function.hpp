...
class Spline3Pose3R3SensorRelativeBetweenCostFunction final
    : public ::ceres::SizedCostFunction<3, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7> {
 public:
  /// Constructor.
  explicit Spline3Pose3R3SensorRelativeBetweenCostFunction(
      const Eigen::Matrix<double, 3, 1>& lambdas_x, const Eigen::Matrix<double, 3, 1>& lambdas_y,
      const Eigen::Matrix<double, 3, 1>& aTb, const Eigen::Matrix<double, 3, 3>& sqrtInfo)
  ...
  /// aTb accessor.
  [[nodiscard]] auto aTb() const -> const Eigen::Matrix<double, 3, 1>& {
    return a_T_b_;
  }

  /// aTb modifier.
  auto aTb() -> Eigen::Matrix<double, 3, 1>& {
    return a_T_b_;
  }
 ...
 private:
  ...
  Eigen::Matrix<double, 3, 1> a_T_b_;
