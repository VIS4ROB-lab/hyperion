...
#include "spline3_pose3_acceleration_global_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline3_pose3_acceleration_global_factor.hpp"
#include "sym/spline3_pose3_acceleration_global_factor_with_jacobians2345.hpp"

namespace hyperion::ceres {

using namespace sym_ceres;

auto Spline3Pose3AccelerationGlobalCostFunction::Evaluate(double const* const* parameters,
                                                          double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
        Spline3Pose3AccelerationGlobalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3,
  ...
  Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
      Spline3Pose3AccelerationGlobalFactorWithJacobians2345<double>(
