...
#include "pose2_sensor_angle_between_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/pose2_sensor_angle_between_factor.hpp"
#include "sym/pose2_sensor_angle_between_factor_with_jacobians013.hpp"

namespace hyperion::ceres {

using namespace sym_ceres;

auto Pose2SensorAngleBetweenCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} = Pose2SensorAngleBetweenFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
      Pose2SensorAngleBetweenFactorWithJacobians013<double>(
