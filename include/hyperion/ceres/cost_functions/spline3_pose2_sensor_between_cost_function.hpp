...
class Spline3Pose2SensorBetweenCostFunction final
 ...
 public:
  /// Constructor.
  explicit Spline3Pose2SensorBetweenCostFunction(const Eigen::Matrix<double, 3, 1>& lambdas,
                                                 const sym::Pose2<double>& sTy,
  ...
  /// sTy accessor.
  [[nodiscard]] auto sTy() const -> const sym::Pose2<double>& {
    return s_T_y_;
  }

  /// sTy modifier.
  auto sTy() -> sym::Pose2<double>& {
    return s_T_y_;
  }
