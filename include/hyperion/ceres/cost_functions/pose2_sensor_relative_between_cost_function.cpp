...
auto Pose2SensorRelativeBetweenCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} = Pose2SensorRelativeBetweenFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Pose2SensorRelativeBetweenFactorWithJacobians0134<double>(
