...
class Spline3Pose2Rot2PriorCostFunction final : public ::ceres::SizedCostFunction<1, 4, 4, 4, 4> {
 public:
  /// Constructor.
  explicit Spline3Pose2Rot2PriorCostFunction(const Eigen::Matrix<double, 3, 1>& lambdas,
