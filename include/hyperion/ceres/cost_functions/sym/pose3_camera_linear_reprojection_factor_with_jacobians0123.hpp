...
Eigen::Matrix<Scalar, 2, 1> Pose3CameraLinearReprojectionFactorWithJacobians0123(
  ...
  const Scalar _tmp31 = _tmp20 * _tmp4;
  ...
  const Scalar _tmp40 = 2 * _w_T_b[2];
  const Scalar _tmp41 = _tmp40 * _w_T_b[0];
  const Scalar _tmp42 = 2 * _w_T_b[1];
  const Scalar _tmp43 = _tmp42 * _w_T_b[3];
  const Scalar _tmp44 = -_tmp43;
  const Scalar _tmp45 = _tmp41 + _tmp44;
  const Scalar _tmp46 = 2 * _w_T_b[0];
  const Scalar _tmp47 = _tmp46 * _w_T_b[3];
  const Scalar _tmp48 = _tmp40 * _w_T_b[1];
  ...
  const Scalar _tmp54 = _tmp46 * _w_T_b[1];
  const Scalar _tmp55 = _tmp40 * _w_T_b[3];
  ...
  const Scalar _tmp69 = _tmp32 * _tmp4;
  ...
  const Scalar _tmp166 = _tmp165 * _tmp86;
  const Scalar _tmp167 = 2 * _w_T_b[3];
  const Scalar _tmp168 = -_tmp117;
  const Scalar _tmp169 = _tmp115 + _tmp122 + _tmp168;
  const Scalar _tmp170 = -_tmp126 * _tmp169;
  const Scalar _tmp171 = -_tmp97;
  const Scalar _tmp172 = _tmp100 + _tmp99;
  const Scalar _tmp173 = _tmp171 + _tmp172 + _tmp98;
  const Scalar _tmp174 = -_tmp146 * _tmp173;
  const Scalar _tmp175 = _tmp170 + _tmp174;
  const Scalar _tmp176 = -_tmp105;
  const Scalar _tmp177 = _tmp107 + _tmp176;
  const Scalar _tmp178 = _tmp110 + _tmp111 + _tmp177;
  const Scalar _tmp179 = _tmp178 * _tmp32;
  const Scalar _tmp180 = _tmp103 * _tmp169;
  const Scalar _tmp181 = _tmp91 + _tmp92;
  const Scalar _tmp182 = -_tmp87;
  const Scalar _tmp183 = _tmp182 + _tmp89;
  const Scalar _tmp184 = _tmp181 + _tmp183;
  const Scalar _tmp185 = _tmp173 * _tmp27 + _tmp184 * _tmp20;
  const Scalar _tmp186 = -_tmp179 - _tmp180 + _tmp185;
  const Scalar _tmp187 = _tmp178 * _tmp20;
  const Scalar _tmp188 = _tmp103 * _tmp173;
  const Scalar _tmp189 = _tmp169 * _tmp27 + _tmp184 * _tmp32;
  const Scalar _tmp190 = _tmp187 + _tmp188 + _tmp189;
  const Scalar _tmp191 = -_tmp51;
  const Scalar _tmp192 = _tmp139 + _tmp191;
  const Scalar _tmp193 = -_tmp41;
  const Scalar _tmp194 = _b_T_c[4] * (_tmp193 + _tmp44) + _b_T_c[6] * (_tmp138 + _tmp192);
  const Scalar _tmp195 = _b_T_c[4] * (_tmp144 + _tmp47) + _b_T_c[6] * _tmp61;
  const Scalar _tmp196 = _b_T_c[4] * (_tmp140 + _tmp191 + _tmp35 + _tmp37) + _b_T_c[6] * _tmp45;
  const Scalar _tmp197 = -_tmp175 * _tmp50 + _tmp175 * l_w(2, 0) - _tmp186 * _tmp64 +
                         _tmp186 * l_w(1, 0) - _tmp190 * _tmp59 + _tmp190 * l_w(0, 0) -
                         _tmp194 * _tmp71 - _tmp195 * _tmp73 - _tmp196 * _tmp68;
  const Scalar _tmp198 = -_tmp128 * _tmp184;
  const Scalar _tmp199 = _tmp170 + _tmp198;
  const Scalar _tmp200 = _tmp179 + _tmp180 + _tmp185;
  const Scalar _tmp201 = _tmp178 * _tmp27;
  const Scalar _tmp202 = _tmp103 * _tmp184;
  const Scalar _tmp203 = _tmp169 * _tmp20 + _tmp173 * _tmp32;
  const Scalar _tmp204 = -_tmp201 - _tmp202 + _tmp203;
  const Scalar _tmp205 =
      -_tmp157 * _tmp197 + _tmp77 * (-_tmp14 * _tmp195 - _tmp194 * _tmp30 - _tmp196 * _tmp34 -
                                     _tmp199 * _tmp64 + _tmp199 * l_w(1, 0) - _tmp200 * _tmp50 +
                                     _tmp200 * l_w(2, 0) - _tmp204 * _tmp59 + _tmp204 * l_w(0, 0));
  const Scalar _tmp206 = -_tmp187 - _tmp188 + _tmp189;
  const Scalar _tmp207 = _tmp174 + _tmp198;
  const Scalar _tmp208 = _tmp201 + _tmp202 + _tmp203;
  const Scalar _tmp209 =
      -_tmp160 * _tmp197 + _tmp84 * (-_tmp194 * _tmp79 - _tmp195 * _tmp82 - _tmp196 * _tmp81 -
                                     _tmp206 * _tmp50 + _tmp206 * l_w(2, 0) - _tmp207 * _tmp59 +
                                     _tmp207 * l_w(0, 0) - _tmp208 * _tmp64 + _tmp208 * l_w(1, 0));
  const Scalar _tmp210 = _tmp205 * sqrt_info(0, 1) + _tmp209 * sqrt_info(0, 0);
  const Scalar _tmp211 = _tmp40 * _tmp86;
  const Scalar _tmp212 = _b_T_c[4] * _tmp49 + _b_T_c[5] * (_tmp193 + _tmp43);
  const Scalar _tmp213 = _tmp119 + _tmp120;
  const Scalar _tmp214 = _tmp116 + _tmp168;
  const Scalar _tmp215 = _tmp213 + _tmp214;
  const Scalar _tmp216 = _tmp20 * _tmp215;
  const Scalar _tmp217 = _tmp182 + _tmp88 + _tmp94;
  const Scalar _tmp218 = _tmp103 * _tmp217;
  const Scalar _tmp219 = -_tmp98;
  const Scalar _tmp220 = _tmp172 + _tmp219 + _tmp97;
  const Scalar _tmp221 = _tmp109 + _tmp112 + _tmp177;
  const Scalar _tmp222 = _tmp220 * _tmp32 + _tmp221 * _tmp27;
  const Scalar _tmp223 = _tmp216 + _tmp218 + _tmp222;
  const Scalar _tmp224 = -_tmp126 * _tmp221;
  const Scalar _tmp225 = -_tmp146 * _tmp217;
  const Scalar _tmp226 = _tmp224 + _tmp225;
  const Scalar _tmp227 = _tmp215 * _tmp32;
  const Scalar _tmp228 = _tmp103 * _tmp221;
  const Scalar _tmp229 = _tmp20 * _tmp220 + _tmp217 * _tmp27;
  const Scalar _tmp230 = -_tmp227 - _tmp228 + _tmp229;
  const Scalar _tmp231 = _tmp143 + _tmp35;
  const Scalar _tmp232 = _b_T_c[4] * _tmp57 + _b_T_c[5] * (_tmp141 + _tmp231);
  const Scalar _tmp233 = _b_T_c[4] * (_tmp192 + _tmp231) + _b_T_c[5] * (_tmp135 + _tmp56);
  const Scalar _tmp234 = -_tmp212 * _tmp68 - _tmp223 * _tmp59 + _tmp223 * l_w(0, 0) -
                         _tmp226 * _tmp50 + _tmp226 * l_w(2, 0) - _tmp230 * _tmp64 +
                         _tmp230 * l_w(1, 0) - _tmp232 * _tmp71 - _tmp233 * _tmp73;
  const Scalar _tmp235 = -_tmp216 - _tmp218 + _tmp222;
  const Scalar _tmp236 = _tmp215 * _tmp27;
  const Scalar _tmp237 = _tmp103 * _tmp220;
  const Scalar _tmp238 = _tmp20 * _tmp221 + _tmp217 * _tmp32;
  const Scalar _tmp239 = _tmp236 + _tmp237 + _tmp238;
  const Scalar _tmp240 = -_tmp128 * _tmp220;
  const Scalar _tmp241 = _tmp225 + _tmp240;
  const Scalar _tmp242 =
      -_tmp160 * _tmp234 + _tmp84 * (-_tmp212 * _tmp81 - _tmp232 * _tmp79 - _tmp233 * _tmp82 -
                                     _tmp235 * _tmp50 + _tmp235 * l_w(2, 0) - _tmp239 * _tmp64 +
                                     _tmp239 * l_w(1, 0) - _tmp241 * _tmp59 + _tmp241 * l_w(0, 0));
  const Scalar _tmp243 = _tmp224 + _tmp240;
  const Scalar _tmp244 = _tmp227 + _tmp228 + _tmp229;
  const Scalar _tmp245 = -_tmp236 - _tmp237 + _tmp238;
  const Scalar _tmp246 =
      -_tmp157 * _tmp234 + _tmp77 * (-_tmp14 * _tmp233 - _tmp212 * _tmp34 - _tmp232 * _tmp30 -
                                     _tmp243 * _tmp64 + _tmp243 * l_w(1, 0) - _tmp244 * _tmp50 +
                                     _tmp244 * l_w(2, 0) - _tmp245 * _tmp59 + _tmp245 * l_w(0, 0));
  const Scalar _tmp247 = _tmp242 * sqrt_info(0, 0) + _tmp246 * sqrt_info(0, 1);
  const Scalar _tmp248 = _tmp42 * _tmp86;
  const Scalar _tmp249 = _tmp158 * sqrt_info(1, 1) + _tmp164 * sqrt_info(1, 0);
  const Scalar _tmp250 = _tmp167 * _tmp86;
  const Scalar _tmp251 = _tmp205 * sqrt_info(1, 1) + _tmp209 * sqrt_info(1, 0);
  const Scalar _tmp252 = _tmp242 * sqrt_info(1, 0) + _tmp246 * sqrt_info(1, 1);
  const Scalar _tmp253 = _tmp46 * _tmp86;
  const Scalar _tmp254 = -_tmp69;
  const Scalar _tmp255 = _tmp254 + _tmp80;
  const Scalar _tmp256 = -_tmp21;
  const Scalar _tmp257 = -_tmp157 * _tmp255 + _tmp77 * (_tmp256 + _tmp28);
  const Scalar _tmp258 = -_tmp160 * _tmp255 + _tmp84 * (_tmp5 + _tmp66 - 1);
  const Scalar _tmp259 = -_tmp31;
  const Scalar _tmp260 = _tmp259 + _tmp33;
  const Scalar _tmp261 = -_tmp160 * _tmp260 + _tmp84 * (_tmp256 + _tmp29);
  const Scalar _tmp262 = _tmp12 - 1;
  const Scalar _tmp263 = -_tmp157 * _tmp260 + _tmp77 * (_tmp262 + _tmp5);
  const Scalar _tmp264 = _tmp262 + _tmp66;
  const Scalar _tmp265 = -_tmp160 * _tmp264 + _tmp84 * (_tmp254 + _tmp70);
  const Scalar _tmp266 = -_tmp157 * _tmp264 + _tmp77 * (_tmp259 + _tmp72);
  const Scalar _tmp267 = _tmp118 + _tmp121 + _tmp214;
  const Scalar _tmp268 = _tmp20 * _tmp267;
  const Scalar _tmp269 = _tmp183 + _tmp90 + _tmp93;
  const Scalar _tmp270 = _tmp103 * _tmp269;
  const Scalar _tmp271 = _tmp101 + _tmp171 + _tmp219;
  ...
  const Scalar _tmp279 = _tmp267 * _tmp32;
  ...
  const Scalar _tmp285 = -_tmp275 * _tmp59 + _tmp275 * l_w(0, 0) - _tmp278 * _tmp50 +
                         _tmp278 * l_w(2, 0) - _tmp284 * _tmp64 + _tmp284 * l_w(1, 0);
  const Scalar _tmp286 = -_tmp268 - _tmp270 + _tmp274;
  const Scalar _tmp287 = _tmp267 * _tmp27;
  ...
  const Scalar _tmp295 =
      -_tmp160 * _tmp285 + _tmp84 * (-_tmp286 * _tmp50 + _tmp286 * l_w(2, 0) - _tmp292 * _tmp64 +
  ...
  const Scalar _tmp300 =
      -_tmp157 * _tmp285 + _tmp77 * (-_tmp296 * _tmp64 + _tmp296 * l_w(1, 0) - _tmp297 * _tmp50 +
                                     _tmp297 * l_w(2, 0) - _tmp299 * _tmp59 + _tmp299 * l_w(0, 0));
  const Scalar _tmp301 = _tmp295 * sqrt_info(0, 0) + _tmp300 * sqrt_info(0, 1);
  const Scalar _tmp302 = 2 * _tmp86;
  const Scalar _tmp303 = _b_T_c[1] * _tmp302;
  const Scalar _tmp304 = -_tmp126 * _tmp267;
  const Scalar _tmp305 = _tmp181 + _tmp87 + _tmp88;
  const Scalar _tmp306 = -_tmp128 * _tmp305;
  const Scalar _tmp307 = _tmp304 + _tmp306;
  const Scalar _tmp308 = _tmp106 + _tmp113 + _tmp176;
  const Scalar _tmp309 = _tmp308 * _tmp32;
  const Scalar _tmp310 = _tmp103 * _tmp267;
  const Scalar _tmp311 = _tmp27 * _tmp271;
  const Scalar _tmp312 = _tmp20 * _tmp305 + _tmp311;
  const Scalar _tmp313 = _tmp309 + _tmp310 + _tmp312;
  const Scalar _tmp314 = _tmp27 * _tmp308;
  const Scalar _tmp315 = _tmp103 * _tmp305;
  const Scalar _tmp316 = _tmp268 + _tmp272;
  const Scalar _tmp317 = -_tmp314 - _tmp315 + _tmp316;
  const Scalar _tmp318 = -_tmp146 * _tmp271;
  const Scalar _tmp319 = _tmp304 + _tmp318;
  const Scalar _tmp320 = -_tmp309 - _tmp310 + _tmp312;
  const Scalar _tmp321 = _tmp305 * _tmp32;
  const Scalar _tmp322 = _tmp20 * _tmp308;
  const Scalar _tmp323 = _tmp289 + _tmp321 + _tmp322;
  const Scalar _tmp324 = -_tmp319 * _tmp50 + _tmp319 * l_w(2, 0) - _tmp320 * _tmp64 +
                         _tmp320 * l_w(1, 0) - _tmp323 * _tmp59 + _tmp323 * l_w(0, 0);
  const Scalar _tmp325 =
      -_tmp157 * _tmp324 + _tmp77 * (-_tmp307 * _tmp64 + _tmp307 * l_w(1, 0) - _tmp313 * _tmp50 +
                                     _tmp313 * l_w(2, 0) - _tmp317 * _tmp59 + _tmp317 * l_w(0, 0));
  const Scalar _tmp326 = _tmp287 + _tmp298 + _tmp321 - _tmp322;
  const Scalar _tmp327 = _tmp306 + _tmp318;
  const Scalar _tmp328 = _tmp314 + _tmp315 + _tmp316;
  const Scalar _tmp329 =
      -_tmp160 * _tmp324 + _tmp84 * (-_tmp326 * _tmp50 + _tmp326 * l_w(2, 0) - _tmp327 * _tmp59 +
                                     _tmp327 * l_w(0, 0) - _tmp328 * _tmp64 + _tmp328 * l_w(1, 0));
  const Scalar _tmp330 = _tmp302 * (_tmp325 * sqrt_info(0, 1) + _tmp329 * sqrt_info(0, 0));
  const Scalar _tmp331 = _tmp20 * _tmp269;
  const Scalar _tmp332 = _tmp115 + _tmp117 + _tmp213;
  const Scalar _tmp333 = _tmp103 * _tmp332;
  const Scalar _tmp334 = _tmp309 + _tmp311;
  const Scalar _tmp335 = -_tmp331 - _tmp333 + _tmp334;
  const Scalar _tmp336 = -_tmp146 * _tmp332;
  const Scalar _tmp337 = -_tmp128 * _tmp308;
  const Scalar _tmp338 = _tmp336 + _tmp337;
  const Scalar _tmp339 = _tmp103 * _tmp308;
  ...
  const Scalar _tmp345 = _tmp27 * _tmp332 + _tmp322;
  ...
  const Scalar _tmp353 = _tmp348 * sqrt_info(0, 0) + _tmp352 * sqrt_info(0, 1);
  const Scalar _tmp354 = _tmp302 * _tmp353;
  const Scalar _tmp355 = _tmp348 * sqrt_info(1, 0) + _tmp352 * sqrt_info(1, 1);
  const Scalar _tmp356 = _tmp302 * _tmp355;
  const Scalar _tmp357 = _tmp302 * (_tmp295 * sqrt_info(1, 0) + _tmp300 * sqrt_info(1, 1));
  const Scalar _tmp358 = _tmp302 * (_tmp325 * sqrt_info(1, 1) + _tmp329 * sqrt_info(1, 0));
  const Scalar _tmp359 = _tmp301 * _tmp302;
  ...
  const Scalar _tmp363 = _tmp155 * (-_tmp49 * _tmp68 - _tmp57 * _tmp71 - _tmp60 * _tmp73);
  const Scalar _tmp364 =
      -_tmp156 * _tmp363 + _tmp77 * (-_tmp14 * _tmp60 - _tmp30 * _tmp57 - _tmp34 * _tmp49);
  const Scalar _tmp365 =
      -_tmp159 * _tmp363 + _tmp84 * (-_tmp49 * _tmp81 - _tmp57 * _tmp79 - _tmp60 * _tmp82);
  ...
  const Scalar _tmp369 = _tmp86 * sqrt_info(0, 0);
  const Scalar _tmp370 = _tmp76 * _tmp83;
  const Scalar _tmp371 = _tmp86 * sqrt_info(1, 0);
  const Scalar _tmp372 = _tmp86 * sqrt_info(0, 1);
  const Scalar _tmp373 = _tmp65 * _tmp76;
  const Scalar _tmp374 = _tmp86 * sqrt_info(1, 1);
  const Scalar _tmp375 = -_tmp157 * _tmp71 + _tmp30 * _tmp77;
  const Scalar _tmp376 = -_tmp160 * _tmp71 + _tmp79 * _tmp84;
  const Scalar _tmp377 = -_tmp160 * _tmp73 + _tmp82 * _tmp84;
  const Scalar _tmp378 = _tmp14 * _tmp77 - _tmp157 * _tmp73;
  const Scalar _tmp379 = -_tmp160 * _tmp68 + _tmp81 * _tmp84;
  const Scalar _tmp380 = -_tmp157 * _tmp68 + _tmp34 * _tmp77;
  ...
  if (res_D_w_T_b != nullptr) {
    ...
    _res_D_w_T_b(0, 0) = _tmp166 * _tmp167 - _tmp210 * _tmp211 + _tmp247 * _tmp248;
    _res_D_w_T_b(1, 0) = -_tmp211 * _tmp251 + _tmp248 * _tmp252 + _tmp249 * _tmp250;
    _res_D_w_T_b(0, 1) = _tmp166 * _tmp40 + _tmp210 * _tmp250 - _tmp247 * _tmp253;
    _res_D_w_T_b(1, 1) = _tmp211 * _tmp249 + _tmp250 * _tmp251 - _tmp252 * _tmp253;
    _res_D_w_T_b(0, 2) = -_tmp165 * _tmp248 + _tmp210 * _tmp253 + _tmp247 * _tmp250;
    _res_D_w_T_b(1, 2) = -_tmp248 * _tmp249 + _tmp250 * _tmp252 + _tmp251 * _tmp253;
    _res_D_w_T_b(0, 3) = -_tmp166 * _tmp46 - _tmp210 * _tmp248 - _tmp211 * _tmp247;
    _res_D_w_T_b(1, 3) = -_tmp211 * _tmp252 - _tmp248 * _tmp251 - _tmp249 * _tmp253;
    _res_D_w_T_b(0, 4) = _tmp86 * (_tmp257 * sqrt_info(0, 1) + _tmp258 * sqrt_info(0, 0));
    _res_D_w_T_b(1, 4) = _tmp86 * (_tmp257 * sqrt_info(1, 1) + _tmp258 * sqrt_info(1, 0));
    _res_D_w_T_b(0, 5) = _tmp86 * (_tmp261 * sqrt_info(0, 0) + _tmp263 * sqrt_info(0, 1));
    _res_D_w_T_b(1, 5) = _tmp86 * (_tmp261 * sqrt_info(1, 0) + _tmp263 * sqrt_info(1, 1));
    _res_D_w_T_b(0, 6) = _tmp86 * (_tmp265 * sqrt_info(0, 0) + _tmp266 * sqrt_info(0, 1));
    _res_D_w_T_b(1, 6) = _tmp86 * (_tmp265 * sqrt_info(1, 0) + _tmp266 * sqrt_info(1, 1));
  }

  if (res_D_b_T_c != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 2, 7, Eigen::RowMajor>> _res_D_b_T_c{res_D_b_T_c};

    _res_D_b_T_c(0, 0) = -_b_T_c[2] * _tmp330 + _b_T_c[3] * _tmp354 + _tmp301 * _tmp303;
    _res_D_b_T_c(1, 0) = _b_T_c[1] * _tmp357 - _b_T_c[2] * _tmp358 + _b_T_c[3] * _tmp356;
    _res_D_b_T_c(0, 1) = -_b_T_c[0] * _tmp359 + _b_T_c[2] * _tmp354 + _b_T_c[3] * _tmp330;
    _res_D_b_T_c(1, 1) = -_b_T_c[0] * _tmp357 + _b_T_c[2] * _tmp356 + _b_T_c[3] * _tmp358;
    _res_D_b_T_c(0, 2) = _b_T_c[0] * _tmp330 + _b_T_c[3] * _tmp359 - _tmp303 * _tmp353;
    _res_D_b_T_c(1, 2) = _b_T_c[0] * _tmp358 + _b_T_c[3] * _tmp357 - _tmp303 * _tmp355;
    _res_D_b_T_c(0, 3) = -_b_T_c[0] * _tmp354 - _b_T_c[1] * _tmp330 - _b_T_c[2] * _tmp359;
    _res_D_b_T_c(1, 3) = -_b_T_c[0] * _tmp356 - _b_T_c[1] * _tmp358 - _b_T_c[2] * _tmp357;
  ...
  if (res_D_calibration != nullptr) {
    ...
    _res_D_calibration(0, 0) = _tmp369 * _tmp370;
    _res_D_calibration(1, 0) = _tmp370 * _tmp371;
    _res_D_calibration(0, 1) = _tmp372 * _tmp373;
    _res_D_calibration(1, 1) = _tmp373 * _tmp374;
    _res_D_calibration(0, 2) = _tmp369;
    _res_D_calibration(1, 2) = _tmp371;
    _res_D_calibration(0, 3) = _tmp372;
    _res_D_calibration(1, 3) = _tmp374;
  }

  if (res_D_l_w != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 2, 3, Eigen::RowMajor>> _res_D_l_w{res_D_l_w};

    _res_D_l_w(0, 0) = _tmp86 * (_tmp375 * sqrt_info(0, 1) + _tmp376 * sqrt_info(0, 0));
    _res_D_l_w(1, 0) = _tmp86 * (_tmp375 * sqrt_info(1, 1) + _tmp376 * sqrt_info(1, 0));
    _res_D_l_w(0, 1) = _tmp86 * (_tmp377 * sqrt_info(0, 0) + _tmp378 * sqrt_info(0, 1));
    _res_D_l_w(1, 1) = _tmp86 * (_tmp377 * sqrt_info(1, 0) + _tmp378 * sqrt_info(1, 1));
    _res_D_l_w(0, 2) = _tmp86 * (_tmp379 * sqrt_info(0, 0) + _tmp380 * sqrt_info(0, 1));
    _res_D_l_w(1, 2) = _tmp86 * (_tmp379 * sqrt_info(1, 0) + _tmp380 * sqrt_info(1, 1));
  }
