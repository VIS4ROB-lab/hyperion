...
Eigen::Matrix<Scalar, 3, 1> Spline3Pose2SensorRelativeBetweenFactor(
  ...
  const Scalar _tmp42 =
      -_a_T_b[3] - _tmp18 * _tmp19 + _tmp18 * _tmp40 + _tmp20 * _tmp21 - _tmp20 * _tmp41;
  const Scalar _tmp43 =
      -_a_T_b[2] - _tmp18 * _tmp21 + _tmp18 * _tmp41 - _tmp19 * _tmp20 + _tmp20 * _tmp40;
  const Scalar _tmp44 = _tmp38 * _y_T_b[0] + _tmp39 * _y_T_b[1];
  const Scalar _tmp45 = -_tmp38 * _y_T_b[1] + _tmp39 * _y_T_b[0];
  const Scalar _tmp46 = _tmp18 * _tmp45 + _tmp20 * _tmp44;
  const Scalar _tmp47 = _tmp18 * _tmp44 - _tmp20 * _tmp45;
  const Scalar _tmp48 = _a_T_b[0] * _tmp46 + _a_T_b[1] * _tmp47;
  const Scalar _tmp49 =
      std::atan2(_a_T_b[0] * _tmp47 - _a_T_b[1] * _tmp46,
                 _tmp48 + epsilon * ((((_tmp48) > 0) - ((_tmp48) < 0)) + Scalar(0.5)));

  // Output terms (1)
  Eigen::Matrix<Scalar, 3, 1> _res;

  _res(0, 0) = _tmp42 * sqrt_info(0, 2) + _tmp43 * sqrt_info(0, 1) + _tmp49 * sqrt_info(0, 0);
  _res(1, 0) = _tmp42 * sqrt_info(1, 2) + _tmp43 * sqrt_info(1, 1) + _tmp49 * sqrt_info(1, 0);
  _res(2, 0) = _tmp42 * sqrt_info(2, 2) + _tmp43 * sqrt_info(2, 1) + _tmp49 * sqrt_info(2, 0);
