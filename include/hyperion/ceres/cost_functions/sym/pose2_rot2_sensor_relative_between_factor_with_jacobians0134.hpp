...
Eigen::Matrix<Scalar, 1, 1> Pose2Rot2SensorRelativeBetweenFactorWithJacobians0134(
  ...
  const Scalar _tmp1 = _x[1] * _x_T_a[0];
  const Scalar _tmp2 = _x[0] * _x_T_a[1];
  const Scalar _tmp3 = _tmp1 + _tmp2;
  const Scalar _tmp4 = _tmp0 * _tmp3;
  const Scalar _tmp5 = _y[0] * _y_T_b[1];
  const Scalar _tmp6 = _y[1] * _y_T_b[0];
  const Scalar _tmp7 = _tmp5 + _tmp6;
  const Scalar _tmp8 = _x[0] * _x_T_a[0] - _x[1] * _x_T_a[1];
  const Scalar _tmp9 = _tmp7 * _tmp8;
  const Scalar _tmp10 = -_tmp4 + _tmp9;
  const Scalar _tmp11 = _tmp0 * _tmp8;
  const Scalar _tmp12 = _tmp11 + _tmp3 * _tmp7;
  const Scalar _tmp13 = _a_T_b[0] * _tmp10 - _a_T_b[1] * _tmp12;
  const Scalar _tmp14 = _a_T_b[0] * _tmp12 + _a_T_b[1] * _tmp10;
  const Scalar _tmp15 = _tmp14 + epsilon * ((((_tmp14) > 0) - ((_tmp14) < 0)) + Scalar(0.5));
  const Scalar _tmp16 = -_tmp1 - _tmp2;
  const Scalar _tmp17 = _tmp0 * _tmp16 + _tmp9;
  const Scalar _tmp18 = -_tmp11 + _tmp16 * _tmp7;
  const Scalar _tmp19 = std::pow(_tmp15, Scalar(2));
  const Scalar _tmp20 = _tmp13 / _tmp19;
  const Scalar _tmp21 = Scalar(1.0) / (_tmp15);
  const Scalar _tmp22 = _tmp19 * sqrt_info(0, 0) / (std::pow(_tmp13, Scalar(2)) + _tmp19);
  const Scalar _tmp23 = _tmp22 * (-_tmp20 * (_a_T_b[0] * _tmp17 + _a_T_b[1] * _tmp18) +
                                  _tmp21 * (_a_T_b[0] * _tmp18 - _a_T_b[1] * _tmp17));
  const Scalar _tmp24 = -_tmp5 - _tmp6;
  const Scalar _tmp25 = _tmp11 - _tmp24 * _tmp3;
  const Scalar _tmp26 = _tmp24 * _tmp8 + _tmp4;
  const Scalar _tmp27 = _tmp22 * (-_tmp20 * (_a_T_b[0] * _tmp26 + _a_T_b[1] * _tmp25) +
                                  _tmp21 * (_a_T_b[0] * _tmp25 - _a_T_b[1] * _tmp26));

  // Output terms (5)
  Eigen::Matrix<Scalar, 1, 1> _res;

  _res(0, 0) = sqrt_info(0, 0) * std::atan2(_tmp13, _tmp15);
  ...
  if (res_D_x_T_a != nullptr) {
    ...
    _res_D_x_T_a(0, 0) = -_tmp23 * _x_T_a[1];
    _res_D_x_T_a(0, 1) = _tmp23 * _x_T_a[0];
    _res_D_x_T_a(0, 2) = 0;
    _res_D_x_T_a(0, 3) = 0;
  }
  ...
  if (res_D_y != nullptr) {
    ...
    _res_D_y(0, 0) = -_tmp27 * _y[1];
    _res_D_y(0, 1) = _tmp27 * _y[0];
    _res_D_y(0, 2) = 0;
    _res_D_y(0, 3) = 0;
  }
  ...
  if (res_D_y_T_b != nullptr) {
    ...
    _res_D_y_T_b(0, 0) = -_tmp27 * _y_T_b[1];
    _res_D_y_T_b(0, 1) = _tmp27 * _y_T_b[0];
    _res_D_y_T_b(0, 2) = 0;
    _res_D_y_T_b(0, 3) = 0;
  }
