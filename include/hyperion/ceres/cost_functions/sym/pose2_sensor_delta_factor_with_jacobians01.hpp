...
Eigen::Matrix<Scalar, 3, 1> Pose2SensorDeltaFactorWithJacobians01(
  ...
  const Scalar _tmp24 = std::pow(_tmp5, Scalar(2));
  const Scalar _tmp25 = _tmp22 / (_tmp22 + _tmp24);
  const Scalar _tmp26 = _tmp25 * (_tmp21 * (_tmp19 * _x_T_y[0] + _tmp20) -
                                  _tmp23 * _tmp5 * (_tmp19 * _x_T_y[1] + _tmp4));
  const Scalar _tmp27 = _tmp11 - _tmp12 - _tmp13;
  const Scalar _tmp28 = -_tmp15 + _tmp16 + _tmp17;
  const Scalar _tmp29 =
      _tmp26 * sqrt_info(0, 0) + _tmp27 * sqrt_info(0, 2) + _tmp28 * sqrt_info(0, 1);
  const Scalar _tmp30 =
      _tmp26 * sqrt_info(1, 0) + _tmp27 * sqrt_info(1, 2) + _tmp28 * sqrt_info(1, 1);
  const Scalar _tmp31 =
      _tmp26 * sqrt_info(2, 0) + _tmp27 * sqrt_info(2, 2) + _tmp28 * sqrt_info(2, 1);
  const Scalar _tmp32 = _tmp25 * (_tmp21 * (_tmp20 - _tmp6) - _tmp23 * _tmp24);
  const Scalar _tmp33 = _tmp32 * _x_T_y[1];
  const Scalar _tmp34 = _tmp32 * _x_T_y[0];
  ...
  if (res_D_x != nullptr) {
    ...
    _res_D_x(0, 0) = -_tmp29 * _x[1];
    _res_D_x(1, 0) = -_tmp30 * _x[1];
    _res_D_x(2, 0) = -_tmp31 * _x[1];
    _res_D_x(0, 1) = _tmp29 * _x[0];
    _res_D_x(1, 1) = _tmp30 * _x[0];
    _res_D_x(2, 1) = _tmp31 * _x[0];
    _res_D_x(0, 2) = -_x[0] * sqrt_info(0, 1) + _x[1] * sqrt_info(0, 2);
    _res_D_x(1, 2) = -_x[0] * sqrt_info(1, 1) + _x[1] * sqrt_info(1, 2);
    _res_D_x(2, 2) = -_x[0] * sqrt_info(2, 1) + _x[1] * sqrt_info(2, 2);
    _res_D_x(0, 3) = -_x[0] * sqrt_info(0, 2) - _x[1] * sqrt_info(0, 1);
    _res_D_x(1, 3) = -_x[0] * sqrt_info(1, 2) - _x[1] * sqrt_info(1, 1);
    _res_D_x(2, 3) = -_x[0] * sqrt_info(2, 2) - _x[1] * sqrt_info(2, 1);
  }

  if (res_D_x_T_y != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 3, 4, Eigen::RowMajor>> _res_D_x_T_y{res_D_x_T_y};

    _res_D_x_T_y(0, 0) = -_tmp33 * sqrt_info(0, 0);
    _res_D_x_T_y(1, 0) = -_tmp33 * sqrt_info(1, 0);
    _res_D_x_T_y(2, 0) = -_tmp33 * sqrt_info(2, 0);
    _res_D_x_T_y(0, 1) = _tmp34 * sqrt_info(0, 0);
    _res_D_x_T_y(1, 1) = _tmp34 * sqrt_info(1, 0);
    _res_D_x_T_y(2, 1) = _tmp34 * sqrt_info(2, 0);
