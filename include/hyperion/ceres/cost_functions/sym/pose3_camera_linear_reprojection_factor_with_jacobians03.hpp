...
Eigen::Matrix<Scalar, 2, 1> Pose3CameraLinearReprojectionFactorWithJacobians03(
  ...
  const Scalar _tmp50 = 2 * _w_T_b[1];
  const Scalar _tmp51 = _tmp50 * _w_T_b[0];
  const Scalar _tmp52 = _tmp38 * _w_T_b[3];
  ...
  const Scalar _tmp154 = -_tmp109;
  const Scalar _tmp155 = _tmp107 + _tmp112 + _tmp154;
  const Scalar _tmp156 = -_tmp116 * _tmp155;
  const Scalar _tmp157 = -_tmp92 + _tmp93 + _tmp96;
  const Scalar _tmp158 = -_tmp136 * _tmp157;
  const Scalar _tmp159 = _tmp156 + _tmp158;
  const Scalar _tmp160 = -_tmp100;
  const Scalar _tmp161 = _tmp101 + _tmp105 + _tmp160;
  const Scalar _tmp162 = _tmp161 * _tmp20;
  const Scalar _tmp163 = _tmp155 * _tmp98;
  const Scalar _tmp164 = -_tmp84;
  const Scalar _tmp165 = _tmp164 + _tmp86 + _tmp87 + _tmp88;
  const Scalar _tmp166 = _tmp157 * _tmp27 + _tmp165 * _tmp66;
  const Scalar _tmp167 = -_tmp162 - _tmp163 + _tmp166;
  const Scalar _tmp168 = _tmp161 * _tmp66;
  const Scalar _tmp169 = _tmp157 * _tmp98;
  const Scalar _tmp170 = _tmp155 * _tmp27 + _tmp165 * _tmp20;
  const Scalar _tmp171 = _tmp168 + _tmp169 + _tmp170;
  const Scalar _tmp172 = -_tmp48;
  const Scalar _tmp173 = _tmp172 + _tmp34;
  const Scalar _tmp174 = -_tmp39;
  const Scalar _tmp175 = _b_T_c[4] * (_tmp174 + _tmp42) + _b_T_c[6] * (_tmp133 + _tmp173);
  const Scalar _tmp176 = _b_T_c[4] * (_tmp134 + _tmp44) + _b_T_c[6] * _tmp57;
  const Scalar _tmp177 = _tmp129 + _tmp36;
  const Scalar _tmp178 = _b_T_c[4] * (_tmp173 + _tmp177) + _b_T_c[6] * _tmp43;
  const Scalar _tmp179 = -_tmp159 * _tmp47 + _tmp159 * l_w(2, 0) - _tmp167 * _tmp60 +
                         _tmp167 * l_w(1, 0) - _tmp171 * _tmp56 + _tmp171 * l_w(0, 0) -
                         _tmp175 * _tmp68 - _tmp176 * _tmp70 - _tmp178 * _tmp64;
  const Scalar _tmp180 = _tmp144 * _tmp146;
  const Scalar _tmp181 = -_tmp118 * _tmp165;
  const Scalar _tmp182 = _tmp156 + _tmp181;
  const Scalar _tmp183 = _tmp162 + _tmp163 + _tmp166;
  const Scalar _tmp184 = _tmp161 * _tmp27;
  const Scalar _tmp185 = _tmp165 * _tmp98;
  const Scalar _tmp186 = _tmp155 * _tmp66 + _tmp157 * _tmp20;
  const Scalar _tmp187 = -_tmp184 - _tmp185 + _tmp186;
  const Scalar _tmp188 =
      -_tmp179 * _tmp180 + _tmp74 * (-_tmp14 * _tmp176 - _tmp175 * _tmp30 - _tmp178 * _tmp33 -
                                     _tmp182 * _tmp60 + _tmp182 * l_w(1, 0) - _tmp183 * _tmp47 +
                                     _tmp183 * l_w(2, 0) - _tmp187 * _tmp56 + _tmp187 * l_w(0, 0));
  const Scalar _tmp189 = _tmp144 * _tmp148;
  const Scalar _tmp190 = -_tmp168 - _tmp169 + _tmp170;
  const Scalar _tmp191 = _tmp158 + _tmp181;
  const Scalar _tmp192 = _tmp184 + _tmp185 + _tmp186;
  const Scalar _tmp193 =
      -_tmp179 * _tmp189 + _tmp81 * (-_tmp175 * _tmp76 - _tmp176 * _tmp79 - _tmp178 * _tmp78 -
                                     _tmp190 * _tmp47 + _tmp190 * l_w(2, 0) - _tmp191 * _tmp56 +
                                     _tmp191 * l_w(0, 0) - _tmp192 * _tmp60 + _tmp192 * l_w(1, 0));
  const Scalar _tmp194 = _tmp83 * (_tmp188 * sqrt_info(0, 1) + _tmp193 * sqrt_info(0, 0));
  const Scalar _tmp195 = _b_T_c[4] * _tmp46 + _b_T_c[5] * (_tmp174 + _tmp41);
  const Scalar _tmp196 = _tmp108 + _tmp110 + _tmp111 + _tmp154;
  const Scalar _tmp197 = _tmp196 * _tmp66;
  const Scalar _tmp198 = _tmp164 + _tmp85 + _tmp89;
  const Scalar _tmp199 = _tmp198 * _tmp98;
  const Scalar _tmp200 = _tmp92 + _tmp93 - _tmp94 + _tmp95;
  const Scalar _tmp201 = _tmp102 + _tmp103 + _tmp104 + _tmp160;
  ...
  const Scalar _tmp211 = _b_T_c[4] * _tmp54 + _b_T_c[5] * (_tmp132 + _tmp177);
  const Scalar _tmp212 =
      _b_T_c[4] * (_tmp128 + _tmp131 + _tmp172 + _tmp36) + _b_T_c[5] * (_tmp125 + _tmp53);
  ...
  const Scalar _tmp214 = -_tmp197 - _tmp199 + _tmp202;
  const Scalar _tmp215 = _tmp196 * _tmp27;
  const Scalar _tmp216 = _tmp200 * _tmp98;
  const Scalar _tmp217 = _tmp198 * _tmp20 + _tmp201 * _tmp66;
  const Scalar _tmp218 = _tmp215 + _tmp216 + _tmp217;
  const Scalar _tmp219 = -_tmp118 * _tmp200;
  const Scalar _tmp220 = _tmp205 + _tmp219;
  const Scalar _tmp221 =
      -_tmp189 * _tmp213 + _tmp81 * (-_tmp195 * _tmp78 - _tmp211 * _tmp76 - _tmp212 * _tmp79 -
                                     _tmp214 * _tmp47 + _tmp214 * l_w(2, 0) - _tmp218 * _tmp60 +
                                     _tmp218 * l_w(1, 0) - _tmp220 * _tmp56 + _tmp220 * l_w(0, 0));
  const Scalar _tmp222 = _tmp204 + _tmp219;
  const Scalar _tmp223 = _tmp207 + _tmp208 + _tmp209;
  const Scalar _tmp224 = -_tmp215 - _tmp216 + _tmp217;
  const Scalar _tmp225 =
      -_tmp180 * _tmp213 + _tmp74 * (-_tmp14 * _tmp212 - _tmp195 * _tmp33 - _tmp211 * _tmp30 -
                                     _tmp222 * _tmp60 + _tmp222 * l_w(1, 0) - _tmp223 * _tmp47 +
                                     _tmp223 * l_w(2, 0) - _tmp224 * _tmp56 + _tmp224 * l_w(0, 0));
  const Scalar _tmp226 = _tmp83 * (_tmp221 * sqrt_info(0, 0) + _tmp225 * sqrt_info(0, 1));
  const Scalar _tmp227 = _tmp83 * (_tmp147 * sqrt_info(1, 1) + _tmp152 * sqrt_info(1, 0));
  const Scalar _tmp228 = _tmp83 * (_tmp188 * sqrt_info(1, 1) + _tmp193 * sqrt_info(1, 0));
  const Scalar _tmp229 = _tmp83 * (_tmp221 * sqrt_info(1, 0) + _tmp225 * sqrt_info(1, 1));
  const Scalar _tmp230 = 2 * _w_T_b[0];
  const Scalar _tmp231 = -_tmp65;
  const Scalar _tmp232 = _tmp231 + _tmp77;
  const Scalar _tmp233 = -_tmp21;
  const Scalar _tmp234 = -_tmp180 * _tmp232 + _tmp74 * (_tmp233 + _tmp28);
  const Scalar _tmp235 = _tmp5 - 1;
  const Scalar _tmp236 = -_tmp189 * _tmp232 + _tmp81 * (_tmp235 + _tmp62);
  const Scalar _tmp237 = -_tmp31;
  const Scalar _tmp238 = _tmp237 + _tmp32;
  const Scalar _tmp239 = -_tmp189 * _tmp238 + _tmp81 * (_tmp233 + _tmp29);
  const Scalar _tmp240 = -_tmp180 * _tmp238 + _tmp74 * (_tmp12 + _tmp235);
  const Scalar _tmp241 = _tmp12 + _tmp62 - 1;
  const Scalar _tmp242 = -_tmp189 * _tmp241 + _tmp81 * (_tmp231 + _tmp67);
  const Scalar _tmp243 = -_tmp180 * _tmp241 + _tmp74 * (_tmp237 + _tmp69);
  const Scalar _tmp244 = -_tmp180 * _tmp68 + _tmp30 * _tmp74;
  const Scalar _tmp245 = -_tmp189 * _tmp68 + _tmp76 * _tmp81;
  const Scalar _tmp246 = -_tmp189 * _tmp70 + _tmp79 * _tmp81;
  const Scalar _tmp247 = _tmp14 * _tmp74 - _tmp180 * _tmp70;
  const Scalar _tmp248 = -_tmp189 * _tmp64 + _tmp78 * _tmp81;
  const Scalar _tmp249 = -_tmp180 * _tmp64 + _tmp33 * _tmp74;
  ...
  if (res_D_w_T_b != nullptr) {
    ...
    _res_D_w_T_b(0, 0) = _tmp153 * _tmp40 - _tmp194 * _tmp38 + _tmp226 * _tmp50;
    _res_D_w_T_b(1, 0) = _tmp227 * _tmp40 - _tmp228 * _tmp38 + _tmp229 * _tmp50;
    _res_D_w_T_b(0, 1) = _tmp153 * _tmp38 + _tmp194 * _tmp40 - _tmp226 * _tmp230;
    _res_D_w_T_b(1, 1) = _tmp227 * _tmp38 + _tmp228 * _tmp40 - _tmp229 * _tmp230;
    _res_D_w_T_b(0, 2) = -_tmp153 * _tmp50 + _tmp194 * _tmp230 + _tmp226 * _tmp40;
    _res_D_w_T_b(1, 2) = -_tmp227 * _tmp50 + _tmp228 * _tmp230 + _tmp229 * _tmp40;
    _res_D_w_T_b(0, 3) = -_tmp153 * _tmp230 - _tmp194 * _tmp50 - _tmp226 * _tmp38;
    _res_D_w_T_b(1, 3) = -_tmp227 * _tmp230 - _tmp228 * _tmp50 - _tmp229 * _tmp38;
    _res_D_w_T_b(0, 4) = _tmp83 * (_tmp234 * sqrt_info(0, 1) + _tmp236 * sqrt_info(0, 0));
    _res_D_w_T_b(1, 4) = _tmp83 * (_tmp234 * sqrt_info(1, 1) + _tmp236 * sqrt_info(1, 0));
    _res_D_w_T_b(0, 5) = _tmp83 * (_tmp239 * sqrt_info(0, 0) + _tmp240 * sqrt_info(0, 1));
    _res_D_w_T_b(1, 5) = _tmp83 * (_tmp239 * sqrt_info(1, 0) + _tmp240 * sqrt_info(1, 1));
    _res_D_w_T_b(0, 6) = _tmp83 * (_tmp242 * sqrt_info(0, 0) + _tmp243 * sqrt_info(0, 1));
    _res_D_w_T_b(1, 6) = _tmp83 * (_tmp242 * sqrt_info(1, 0) + _tmp243 * sqrt_info(1, 1));
  }

  if (res_D_l_w != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 2, 3, Eigen::RowMajor>> _res_D_l_w{res_D_l_w};

    _res_D_l_w(0, 0) = _tmp83 * (_tmp244 * sqrt_info(0, 1) + _tmp245 * sqrt_info(0, 0));
    _res_D_l_w(1, 0) = _tmp83 * (_tmp244 * sqrt_info(1, 1) + _tmp245 * sqrt_info(1, 0));
    _res_D_l_w(0, 1) = _tmp83 * (_tmp246 * sqrt_info(0, 0) + _tmp247 * sqrt_info(0, 1));
    _res_D_l_w(1, 1) = _tmp83 * (_tmp246 * sqrt_info(1, 0) + _tmp247 * sqrt_info(1, 1));
    _res_D_l_w(0, 2) = _tmp83 * (_tmp248 * sqrt_info(0, 0) + _tmp249 * sqrt_info(0, 1));
    _res_D_l_w(1, 2) = _tmp83 * (_tmp248 * sqrt_info(1, 0) + _tmp249 * sqrt_info(1, 1));
  }
