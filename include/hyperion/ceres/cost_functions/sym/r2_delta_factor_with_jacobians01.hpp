 ...
 * Outputs:
 *     res: Matrix21
 *     res_D_x: (2x2) jacobian (result_dim x storage_dim) of res (2) wrt arg x (2) (row-major)
 *     res_D_y: (2x2) jacobian (result_dim x storage_dim) of res (2) wrt arg y (2) (row-major)
 */
template <typename Scalar>
Eigen::Matrix<Scalar, 2, 1> R2DeltaFactorWithJacobians01(
  ...
  if (res_D_x != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 2, 2, Eigen::RowMajor>> _res_D_x{res_D_x};
  ...
  if (res_D_y != nullptr) {
    Eigen::Map<Eigen::Matrix<Scalar, 2, 2, Eigen::RowMajor>> _res_D_y{res_D_y};
