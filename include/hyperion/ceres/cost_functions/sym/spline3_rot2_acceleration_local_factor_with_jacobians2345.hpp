...
Eigen::Matrix<Scalar, 1, 1> Spline3Rot2AccelerationLocalFactorWithJacobians2345(
  ...
  const Scalar _tmp26 = _tmp23 * lambdas(0, 2) / (_tmp22 + _tmp23);
  const Scalar _tmp27 = _tmp0 * sqrt_info(0, 0);
  ...
  const Scalar _tmp33 = _tmp31 * lambdas(1, 2) / (_tmp30 + _tmp31);
  const Scalar _tmp34 =
      _tmp27 * (_tmp26 * (-_tmp17 * _tmp24 * (_tmp15 - _tmp16) + _tmp20 * _tmp25) +
  ...
  const Scalar _tmp39 = _tmp37 * lambdas(2, 2) / (_tmp36 + _tmp37);
  const Scalar _tmp40 = _tmp27 * (_tmp33 * (-_tmp10 * _tmp32 * (-_tmp8 + _tmp9) + _tmp13 * _tmp29) +
                                  _tmp39 * (_tmp35 * (-_tmp4 - _tmp5) - _tmp36 * _tmp38));
  const Scalar _tmp41 = _tmp27 * _tmp39 * (-_tmp3 * _tmp38 * (_tmp1 - _tmp2) + _tmp35 * _tmp6);
