...
class Pose2SensorAngleBetweenCostFunction final : public ::ceres::SizedCostFunction<1, 4, 4, 4> {
 public:
  /// Constructor.
  explicit Pose2SensorAngleBetweenCostFunction(const Eigen::Matrix<double, 1, 1>& sdy,
