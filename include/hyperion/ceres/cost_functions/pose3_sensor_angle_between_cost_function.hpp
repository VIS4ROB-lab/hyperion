...
class Pose3SensorAngleBetweenCostFunction final : public ::ceres::SizedCostFunction<1, 7, 7, 7> {
 public:
  /// Constructor.
  explicit Pose3SensorAngleBetweenCostFunction(const Eigen::Matrix<double, 1, 1>& sdy,
