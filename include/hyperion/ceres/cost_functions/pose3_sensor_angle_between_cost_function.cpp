...
auto Pose3SensorAngleBetweenCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} = Pose3SensorAngleBetweenFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
      Pose3SensorAngleBetweenFactorWithJacobians013<double>(
