...
class R3EuclideanDistanceCostFunction final : public ::ceres::SizedCostFunction<1, 3, 3> {
 public:
  /// Constructor.
  explicit R3EuclideanDistanceCostFunction(const Eigen::Matrix<double, 1, 1>& xdy,
