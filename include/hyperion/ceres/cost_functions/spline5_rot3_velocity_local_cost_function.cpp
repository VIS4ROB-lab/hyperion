...
#include "spline5_rot3_velocity_local_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline5_rot3_velocity_local_factor.hpp"
#include "sym/spline5_rot3_velocity_local_factor_with_jacobians234567.hpp"

namespace hyperion::ceres {

using namespace sym_ceres;

auto Spline5Rot3VelocityLocalCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
        Spline5Rot3VelocityLocalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, _x5,
                                               velocity_, sqrt_info_, sym::kDefaultEpsilon<double>);
    return true;
  }

  // Evaluation with Jacobians.
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline5Rot3VelocityLocalFactorWithJacobians234567<double>(
