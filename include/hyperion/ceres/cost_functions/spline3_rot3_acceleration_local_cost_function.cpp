...
#include "spline3_rot3_acceleration_local_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline3_rot3_acceleration_local_factor.hpp"
#include "sym/spline3_rot3_acceleration_local_factor_with_jacobians2345.hpp"

namespace hyperion::ceres {

using namespace sym_ceres;

auto Spline3Rot3AccelerationLocalCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} = Spline3Rot3AccelerationLocalFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline3Rot3AccelerationLocalFactorWithJacobians2345<double>(
