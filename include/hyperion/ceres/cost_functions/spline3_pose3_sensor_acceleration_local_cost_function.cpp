...
#include "spline3_pose3_sensor_acceleration_local_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline3_pose3_sensor_acceleration_local_factor.hpp"
#include "sym/spline3_pose3_sensor_acceleration_local_factor_with_jacobians23456.hpp"

namespace hyperion::ceres {

using namespace sym_ceres;

auto Spline3Pose3SensorAccelerationLocalCostFunction::Evaluate(double const* const* parameters,
                                                               double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
        Spline3Pose3SensorAccelerationLocalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x_T_s,
  ...
  Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
      Spline3Pose3SensorAccelerationLocalFactorWithJacobians23456<double>(
