...
auto Spline3Pose2PriorCostFunction::Evaluate(double const* const* parameters, double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} = Spline3Pose2DeltaFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline3Pose2DeltaFactorWithJacobians1234<double>(lambdas_, _x0, _x1, _x2, _x3, y_, sqrt_info_,
