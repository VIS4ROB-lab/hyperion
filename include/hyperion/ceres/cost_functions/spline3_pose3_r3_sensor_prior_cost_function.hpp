...
class Spline3Pose3R3SensorPriorCostFunction final
    : public ::ceres::SizedCostFunction<3, 7, 7, 7, 7, 3> {
 public:
  /// Constructor.
  explicit Spline3Pose3R3SensorPriorCostFunction(const Eigen::Matrix<double, 3, 1>& lambdas,
