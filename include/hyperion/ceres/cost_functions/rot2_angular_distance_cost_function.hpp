...
class Rot2AngularDistanceCostFunction final : public ::ceres::SizedCostFunction<1, 2, 2> {
 public:
  /// Constructor.
  explicit Rot2AngularDistanceCostFunction(const Eigen::Matrix<double, 1, 1>& xdy,
