...
class Spline3Rot2AccelerationLocalCostFunction final
 ...
 public:
  /// Constructor.
  explicit Spline3Rot2AccelerationLocalCostFunction(const double dt,
                                                    const Eigen::Matrix<double, 3, 3>& lambdas,
                                                    const Eigen::Matrix<double, 1, 1>& acceleration,
  ...
  [[nodiscard]] auto acceleration() const -> const Eigen::Matrix<double, 1, 1>& {
    return acceleration_;
  }

  /// acceleration modifier.
  auto acceleration() -> Eigen::Matrix<double, 1, 1>& {
    return acceleration_;
  }
 ...
 private:
  ...
  Eigen::Matrix<double, 1, 1> acceleration_;
