...
class Spline5Pose3AccelerationGlobalCostFunction final
    : public ::ceres::SizedCostFunction<6, 7, 7, 7, 7, 7, 7> {
 public:
  /// Constructor.
  explicit Spline5Pose3AccelerationGlobalCostFunction(
      const double dt, const Eigen::Matrix<double, 5, 3>& lambdas,
      const Eigen::Matrix<double, 6, 1>& acceleration, const Eigen::Matrix<double, 6, 6>& sqrtInfo)
  ...
  [[nodiscard]] auto acceleration() const -> const Eigen::Matrix<double, 6, 1>& {
    return acceleration_;
  }

  /// acceleration modifier.
  auto acceleration() -> Eigen::Matrix<double, 6, 1>& {
    return acceleration_;
  }
