...
auto Spline5Rot3AccelerationGlobalCostFunction::Evaluate(double const* const* parameters,
                                                         double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
        Spline5Rot3AccelerationGlobalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, _x5,
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline5Rot3AccelerationGlobalFactorWithJacobians234567<double>(
