...
auto Spline3Rot2AccelerationGlobalCostFunction::Evaluate(double const* const* parameters,
                                                         double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
        Spline3Rot2AccelerationGlobalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3,
  ...
  Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
      Spline3Rot2AccelerationGlobalFactorWithJacobians2345<double>(
