...
#include "spline5_pose3_acceleration_global_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline5_pose3_acceleration_global_factor.hpp"
#include "sym/spline5_pose3_acceleration_global_factor_with_jacobians234567.hpp"

namespace hyperion::ceres {

using namespace sym_ceres;

auto Spline5Pose3AccelerationGlobalCostFunction::Evaluate(double const* const* parameters,
                                                          double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
        Spline5Pose3AccelerationGlobalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, _x5,
  ...
  Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
      Spline5Pose3AccelerationGlobalFactorWithJacobians234567<double>(
