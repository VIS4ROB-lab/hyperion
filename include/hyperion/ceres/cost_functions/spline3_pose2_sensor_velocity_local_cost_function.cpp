...
auto Spline3Pose2SensorVelocityLocalCostFunction::Evaluate(double const* const* parameters,
                                                           double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
        Spline3Pose2SensorVelocityLocalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3, _x_T_s,
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline3Pose2SensorVelocityLocalFactorWithJacobians23456<double>(
