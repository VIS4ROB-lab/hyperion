...
class Spline3Pose3R3PriorCostFunction final : public ::ceres::SizedCostFunction<3, 7, 7, 7, 7> {
 public:
  /// Constructor.
  explicit Spline3Pose3R3PriorCostFunction(const Eigen::Matrix<double, 3, 1>& lambdas,
                                           const Eigen::Matrix<double, 3, 1>& prior,
