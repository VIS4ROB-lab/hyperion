...
auto Pose3SensorBetweenCostFunction::Evaluate(double const* const* parameters, double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} = Pose3SensorBetweenFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
      Pose3SensorBetweenFactorWithJacobians013<double>(_x, _x_T_s, s_T_y_, _y, sqrt_info_,
