...
auto Spline3Pose3R3PriorCostFunction::Evaluate(double const* const* parameters, double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} = Spline3Pose3R3DeltaFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline3Pose3R3DeltaFactorWithJacobians1234<double>(
