...
class Spline3Pose2SensorRelativeBetweenCostFunction final
    : public ::ceres::SizedCostFunction<3, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4> {
 public:
  /// Constructor.
  explicit Spline3Pose2SensorRelativeBetweenCostFunction(
      const Eigen::Matrix<double, 3, 1>& lambdas_x, const Eigen::Matrix<double, 3, 1>& lambdas_y,
      const sym::Pose2<double>& aTb, const Eigen::Matrix<double, 3, 3>& sqrtInfo)
