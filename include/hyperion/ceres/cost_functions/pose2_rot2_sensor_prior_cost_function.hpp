...
class Pose2Rot2SensorPriorCostFunction final : public ::ceres::SizedCostFunction<1, 4, 2> {
 public:
  /// Constructor.
  explicit Pose2Rot2SensorPriorCostFunction(const sym::Pose2<double>& prior,
