...
auto Spline3Pose3CameraLinearBearingCostFunction::Evaluate(double const* const* parameters,
                                                           double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
        Spline3Pose3CameraLinearBearingFactor<double>(lambdas_, _x0, _x1, _x2, _x3, _b_T_c,
  ...
  switch (bits | std::uint8_t{0b1111001}) {
    case std::uint8_t{0b1111111}: {
      Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
          Spline3Pose3CameraLinearBearingFactorWithJacobians1234567<double>(
    ...
    case std::uint8_t{0b1111101}: {
      Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
          Spline3Pose3CameraLinearBearingFactorWithJacobians123457<double>(
              lambdas_, _x0, _x1, _x2, _x3, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_,
              sym::kDefaultEpsilon<double>, jacobians[0], jacobians[1], jacobians[2], jacobians[3],
    ...
    case std::uint8_t{0b1111011}: {
      Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
          Spline3Pose3CameraLinearBearingFactorWithJacobians123467<double>(
              lambdas_, _x0, _x1, _x2, _x3, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_,
              sym::kDefaultEpsilon<double>, jacobians[0], jacobians[1], jacobians[2], jacobians[3],
    ...
    case std::uint8_t{0b1111001}: {
      Eigen::Map<Eigen::Matrix<double, 1, 1>>{residuals} =
          Spline3Pose3CameraLinearBearingFactorWithJacobians12347<double>(
              lambdas_, _x0, _x1, _x2, _x3, _b_T_c, _calibration, _l_w, pixel_, sqrt_info_,
              sym::kDefaultEpsilon<double>, jacobians[0], jacobians[1], jacobians[2], jacobians[3],
              jacobians[6]);
      return true;
