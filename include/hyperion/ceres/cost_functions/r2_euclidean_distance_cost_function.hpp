...
class R2EuclideanDistanceCostFunction final : public ::ceres::SizedCostFunction<1, 2, 2> {
 public:
  /// Constructor.
  explicit R2EuclideanDistanceCostFunction(const Eigen::Matrix<double, 1, 1>& xdy,
