...
class Spline3Pose3Rot3PriorCostFunction final : public ::ceres::SizedCostFunction<3, 7, 7, 7, 7> {
 public:
  /// Constructor.
  explicit Spline3Pose3Rot3PriorCostFunction(const Eigen::Matrix<double, 3, 1>& lambdas,
