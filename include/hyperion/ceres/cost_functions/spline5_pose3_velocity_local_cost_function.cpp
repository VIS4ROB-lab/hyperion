...
auto Spline5Pose3VelocityLocalCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} = Spline5Pose3VelocityLocalFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
      Spline5Pose3VelocityLocalFactorWithJacobians234567<double>(
          dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, _x5, velocity_, sqrt_info_,
