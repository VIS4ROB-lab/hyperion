...
auto Spline3Pose3AccelerationLocalCostFunction::Evaluate(double const* const* parameters,
                                                         double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
        Spline3Pose3AccelerationLocalFactor<double>(dt_, lambdas_, _x0, _x1, _x2, _x3,
  ...
  Eigen::Map<Eigen::Matrix<double, 6, 1>>{residuals} =
      Spline3Pose3AccelerationLocalFactorWithJacobians2345<double>(
