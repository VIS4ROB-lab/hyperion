...
#include "spline5_rot3_velocity_global_cost_function.hpp"

#include <sym/ops/storage_ops.h>
#include <sym/util/epsilon.h>

#include "sym/spline5_rot3_velocity_global_factor.hpp"
#include "sym/spline5_rot3_velocity_global_factor_with_jacobians234567.hpp"

namespace hyperion::ceres {

using namespace sym_ceres;

auto Spline5Rot3VelocityGlobalCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} = Spline5Rot3VelocityGlobalFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline5Rot3VelocityGlobalFactorWithJacobians234567<double>(
          dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, _x5, velocity_, sqrt_info_,
