...
auto Spline4Rot3AccelerationLocalCostFunction::Evaluate(double const* const* parameters,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} = Spline4Rot3AccelerationLocalFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline4Rot3AccelerationLocalFactorWithJacobians23456<double>(
          dt_, lambdas_, _x0, _x1, _x2, _x3, _x4, acceleration_, sqrt_info_,
