...
auto Pose3R3SensorBetweenCostFunction::Evaluate(double const* const* parameters, double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} = Pose3R3SensorBetweenFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Pose3R3SensorBetweenFactorWithJacobians013<double>(_x, _x_T_s, s_T_y_, _y, sqrt_info_,
