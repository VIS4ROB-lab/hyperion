...
auto Spline3Pose3Rot3SensorRelativeBetweenCostFunction::Evaluate(double const* const* parameters,
                                                                 double* residuals,
  ...
  if (!jacobians) {
    Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
        Spline3Pose3Rot3SensorRelativeBetweenFactor<double>(
  ...
  Eigen::Map<Eigen::Matrix<double, 3, 1>>{residuals} =
      Spline3Pose3Rot3SensorRelativeBetweenFactorWithJacobians1234589101112<double>(
          lambdas_x_, _x0, _x1, _x2, _x3, _x_T_a, a_T_b_, lambdas_y_, _y0, _y1, _y2, _y3, _y_T_b,
