...
class R2AngularDistanceCostFunction final : public ::ceres::SizedCostFunction<1, 2, 2> {
 public:
  /// Constructor.
  explicit R2AngularDistanceCostFunction(const Eigen::Matrix<double, 1, 1>& xdy,
