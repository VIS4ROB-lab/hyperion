...
class Pose2SensorEuclideanDistanceCostFunction final
    : public ::ceres::SizedCostFunction<1, 4, 4, 4> {
 public:
  /// Constructor.
  explicit Pose2SensorEuclideanDistanceCostFunction(const Eigen::Matrix<double, 1, 1>& sdy,
