...
class Spline3Pose3PriorCostFunction final : public ::ceres::SizedCostFunction<6, 7, 7, 7, 7> {
 public:
  /// Constructor.
  explicit Spline3Pose3PriorCostFunction(const Eigen::Matrix<double, 3, 1>& lambdas,
