...
class Spline3Pose3Rot3SensorBetweenCostFunction final
    : public ::ceres::SizedCostFunction<3, 7, 7, 7, 7, 7, 7> {
 public:
  /// Constructor.
  explicit Spline3Pose3Rot3SensorBetweenCostFunction(const Eigen::Matrix<double, 3, 1>& lambdas,
                                                     const sym::Rot3<double>& sTy,
